...
func RegisterAuthorizationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AuthorizationServiceServer) error {
	...
	mux.Handle("POST", pattern_AuthorizationService_IsAuthorized_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/authorization.AuthorizationService/IsAuthorized", runtime.WithHTTPPathPattern("/authorization"))
		if err != nil {
...
func RegisterAuthorizationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AuthorizationServiceClient) error {
	...
	mux.Handle("POST", pattern_AuthorizationService_IsAuthorized_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/authorization.AuthorizationService/IsAuthorized", runtime.WithHTTPPathPattern("/authorization"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_AuthorizationService_IsAuthorized_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"authorization"}, ""))
)
