// Package cryptoutil provides TinyGo-safe cryptographic utility functions.
// These functions depend only on standard library packages that compile
// successfully under TinyGo, making them suitable for WASM targets.
package cryptoutil
