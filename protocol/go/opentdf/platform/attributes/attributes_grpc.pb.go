...
const (
	AttributesService_ListAttributes_FullMethodName                     = "/opentdf.platform.attributes.AttributesService/ListAttributes"
	AttributesService_ListAttributeValues_FullMethodName                = "/opentdf.platform.attributes.AttributesService/ListAttributeValues"
	AttributesService_GetAttribute_FullMethodName                       = "/opentdf.platform.attributes.AttributesService/GetAttribute"
	AttributesService_CreateAttribute_FullMethodName                    = "/opentdf.platform.attributes.AttributesService/CreateAttribute"
	AttributesService_UpdateAttribute_FullMethodName                    = "/opentdf.platform.attributes.AttributesService/UpdateAttribute"
	AttributesService_DeleteAttribute_FullMethodName                    = "/opentdf.platform.attributes.AttributesService/DeleteAttribute"
	AttributesService_GetAttributeValue_FullMethodName                  = "/opentdf.platform.attributes.AttributesService/GetAttributeValue"
	AttributesService_CreateAttributeValue_FullMethodName               = "/opentdf.platform.attributes.AttributesService/CreateAttributeValue"
	AttributesService_UpdateAttributeValue_FullMethodName               = "/opentdf.platform.attributes.AttributesService/UpdateAttributeValue"
	AttributesService_DeleteAttributeValue_FullMethodName               = "/opentdf.platform.attributes.AttributesService/DeleteAttributeValue"
	AttributesService_AssignKeyAccessServerToAttribute_FullMethodName   = "/opentdf.platform.attributes.AttributesService/AssignKeyAccessServerToAttribute"
	AttributesService_RemoveKeyAccessServerFromAttribute_FullMethodName = "/opentdf.platform.attributes.AttributesService/RemoveKeyAccessServerFromAttribute"
	AttributesService_AssignKeyAccessServerToValue_FullMethodName       = "/opentdf.platform.attributes.AttributesService/AssignKeyAccessServerToValue"
	AttributesService_RemoveKeyAccessServerFromValue_FullMethodName     = "/opentdf.platform.attributes.AttributesService/RemoveKeyAccessServerFromValue"
)
...
var AttributesService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "opentdf.platform.attributes.AttributesService",
	...
	Metadata: "opentdf/platform/attributes/attributes.proto",
}
