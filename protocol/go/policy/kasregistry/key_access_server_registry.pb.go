...
const (
	TdfType_TDF_TYPE_UNSPECIFIED TdfType = 0
	TdfType_TDF_TYPE_ZTDF        TdfType = 1
	TdfType_TDF_TYPE_NANO        TdfType = 2
)

// Enum value maps for TdfType.
var (
	TdfType_name = map[int32]string{
		0: "TDF_TYPE_UNSPECIFIED",
		1: "TDF_TYPE_ZTDF",
		2: "TDF_TYPE_NANO",
	}
	TdfType_value = map[string]int32{
		"TDF_TYPE_UNSPECIFIED": 0,
		"TDF_TYPE_ZTDF":        1,
		"TDF_TYPE_NANO":        2,
	}
)

func (x TdfType) Enum() *TdfType {
	p := new(TdfType)
	*p = x
	return p
}

func (x TdfType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TdfType) Descriptor() protoreflect.EnumDescriptor {
	return file_policy_kasregistry_key_access_server_registry_proto_enumTypes[0].Descriptor()
}

func (TdfType) Type() protoreflect.EnumType {
	return &file_policy_kasregistry_key_access_server_registry_proto_enumTypes[0]
}

func (x TdfType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TdfType.Descriptor instead.
func (TdfType) EnumDescriptor() ([]byte, []int) {
...
type SetDefaultKeyRequest struct {
	...
	// Types that are assignable to ActiveKey:
	//
	//	*SetDefaultKeyRequest_Id
	//	*SetDefaultKeyRequest_Key
	ActiveKey isSetDefaultKeyRequest_ActiveKey `protobuf_oneof:"active_key"`
	// Required
	TdfType TdfType `protobuf:"varint,3,opt,name=tdf_type,json=tdfType,proto3,enum=policy.kasregistry.TdfType" json:"tdf_type,omitempty"` // The type of TDF (e.g., ZTDF, Nano)
}
...
func (m *SetDefaultKeyRequest) GetActiveKey() isSetDefaultKeyRequest_ActiveKey {
	if m != nil {
		return m.ActiveKey
	}
	return nil
...
func (x *SetDefaultKeyRequest) GetId() string {
	if x, ok := x.GetActiveKey().(*SetDefaultKeyRequest_Id); ok {
		return x.Id
	}
	return ""
}

func (x *SetDefaultKeyRequest) GetKey() *KasKeyIdentifier {
	if x, ok := x.GetActiveKey().(*SetDefaultKeyRequest_Key); ok {
		return x.Key
	}
	return nil
}

func (x *SetDefaultKeyRequest) GetTdfType() TdfType {
	if x != nil {
		return x.TdfType
	}
	return TdfType_TDF_TYPE_UNSPECIFIED
}

type isSetDefaultKeyRequest_ActiveKey interface {
	isSetDefaultKeyRequest_ActiveKey()
}

type SetDefaultKeyRequest_Id struct {
	// Current Key UUID tp be set as default
	Id string `protobuf:"bytes,1,opt,name=id,proto3,oneof"`
}

type SetDefaultKeyRequest_Key struct {
	// Alternative way to specify the key using KAS ID and Key ID
	Key *KasKeyIdentifier `protobuf:"bytes,2,opt,name=key,proto3,oneof"`
}

func (*SetDefaultKeyRequest_Id) isSetDefaultKeyRequest_ActiveKey() {}

func (*SetDefaultKeyRequest_Key) isSetDefaultKeyRequest_ActiveKey() {}

type DefaultKasPublicKey struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DefaultKasPublicKey) Reset() {
	*x = DefaultKasPublicKey{}
	if protoimpl.UnsafeEnabled {
...
func (x *DefaultKasPublicKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DefaultKasPublicKey) ProtoMessage() {}

func (x *DefaultKasPublicKey) ProtoReflect() protoreflect.Message {
	mi := &file_policy_kasregistry_key_access_server_registry_proto_msgTypes[42]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DefaultKasPublicKey.ProtoReflect.Descriptor instead.
func (*DefaultKasPublicKey) Descriptor() ([]byte, []int) {
	return file_policy_kasregistry_key_access_server_registry_proto_rawDescGZIP(), []int{42}
}

func (x *DefaultKasPublicKey) GetAlgorithm() string {
	if x != nil {
		return x.Algorithm
	}
	return ""
...
func (x *DefaultKasPublicKey) GetKid() string {
	if x != nil {
		return x.Kid
	}
	return ""
...
func (x *DefaultKasPublicKey) GetPem() string {
	if x != nil {
		return x.Pem
	}
	return ""
...
type DefaultKasKey struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	TdfType   string               `protobuf:"bytes,1,opt,name=tdf_type,json=tdfType,proto3" json:"tdf_type,omitempty"`       // The type of TDF (e.g., ZTDF, Nano)
	KasUri    string               `protobuf:"bytes,2,opt,name=kas_uri,json=kasUri,proto3" json:"kas_uri,omitempty"`          // The URL of the Key Access Server
	PublicKey *DefaultKasPublicKey `protobuf:"bytes,3,opt,name=public_key,json=publicKey,proto3" json:"public_key,omitempty"` // The public key of the Key that belongs to the KAS
}

func (x *DefaultKasKey) Reset() {
	*x = DefaultKasKey{}
	if protoimpl.UnsafeEnabled {
...
func (x *DefaultKasKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DefaultKasKey) ProtoMessage() {}

func (x *DefaultKasKey) ProtoReflect() protoreflect.Message {
	mi := &file_policy_kasregistry_key_access_server_registry_proto_msgTypes[43]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DefaultKasKey.ProtoReflect.Descriptor instead.
func (*DefaultKasKey) Descriptor() ([]byte, []int) {
	return file_policy_kasregistry_key_access_server_registry_proto_rawDescGZIP(), []int{43}
}

func (x *DefaultKasKey) GetTdfType() string {
	if x != nil {
		return x.TdfType
	}
	return ""
...
func (x *DefaultKasKey) GetKasUri() string {
	if x != nil {
		return x.KasUri
	}
	return ""
...
func (x *DefaultKasKey) GetPublicKey() *DefaultKasPublicKey {
	if x != nil {
		return x.PublicKey
	}
	return nil
...
type GetDefaultKeysRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *GetDefaultKeysRequest) Reset() {
	*x = GetDefaultKeysRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetDefaultKeysRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetDefaultKeysRequest) ProtoMessage() {}

func (x *GetDefaultKeysRequest) ProtoReflect() protoreflect.Message {
	mi := &file_policy_kasregistry_key_access_server_registry_proto_msgTypes[44]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetDefaultKeysRequest.ProtoReflect.Descriptor instead.
func (*GetDefaultKeysRequest) Descriptor() ([]byte, []int) {
	return file_policy_kasregistry_key_access_server_registry_proto_rawDescGZIP(), []int{44}
}

type GetDefaultKeysResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	DefaultKasKeys []*DefaultKasKey `protobuf:"bytes,1,rep,name=default_kas_keys,json=defaultKasKeys,proto3" json:"default_kas_keys,omitempty"` // The list of default keys
}

func (x *GetDefaultKeysResponse) Reset() {
	*x = GetDefaultKeysResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetDefaultKeysResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetDefaultKeysResponse) ProtoMessage() {}

func (x *GetDefaultKeysResponse) ProtoReflect() protoreflect.Message {
	mi := &file_policy_kasregistry_key_access_server_registry_proto_msgTypes[45]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetDefaultKeysResponse.ProtoReflect.Descriptor instead.
func (*GetDefaultKeysResponse) Descriptor() ([]byte, []int) {
	return file_policy_kasregistry_key_access_server_registry_proto_rawDescGZIP(), []int{45}
}

func (x *GetDefaultKeysResponse) GetDefaultKasKeys() []*DefaultKasKey {
	if x != nil {
		return x.DefaultKasKeys
	}
	return nil
}
...
type SetDefaultKeyResponse struct {
	...
	NewDefaultKasKey      *DefaultKasKey `protobuf:"bytes,1,opt,name=new_default_kas_key,json=newDefaultKasKey,proto3" json:"new_default_kas_key,omitempty"`                // The key that was set as default
	PreviousDefaultKasKey *DefaultKasKey `protobuf:"bytes,2,opt,name=previous_default_kas_key,json=previousDefaultKasKey,proto3" json:"previous_default_kas_key,omitempty"` // The previous default key, if any
}

func (x *SetDefaultKeyResponse) Reset() {
	*x = SetDefaultKeyResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SetDefaultKeyResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetDefaultKeyResponse) ProtoMessage() {}

func (x *SetDefaultKeyResponse) ProtoReflect() protoreflect.Message {
	mi := &file_policy_kasregistry_key_access_server_registry_proto_msgTypes[46]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetDefaultKeyResponse.ProtoReflect.Descriptor instead.
func (*SetDefaultKeyResponse) Descriptor() ([]byte, []int) {
	return file_policy_kasregistry_key_access_server_registry_proto_rawDescGZIP(), []int{46}
}

func (x *SetDefaultKeyResponse) GetNewDefaultKasKey() *DefaultKasKey {
	if x != nil {
		return x.NewDefaultKasKey
	}
	return nil
}

func (x *SetDefaultKeyResponse) GetPreviousDefaultKasKey() *DefaultKasKey {
	if x != nil {
		return x.PreviousDefaultKasKey
	}
	return nil
}
...
type RotateKeyRequest_NewKey struct {
	...
	// Conditionally Required. If the key_mode is REMOTE, this field is required.
...
var file_policy_kasregistry_key_access_server_registry_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x22, 0x86, 0x08, 0x0a, 0x10, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4b, 0x65, 0x79,
	...
	,
	...
	0x64, 0x61, 0x74, 0x61, 0x3a, 0xf4, 0x03, 0xba, 0x48, 0xf0, 0x03, 0x1a, 0xb4, 0x02, 0x0a, 0x23,
	...
	,
	...
	0x20, 0x7c, 0x7c, 0x20, 0x28, 0x74, 0x68, 0x69, 0x73, 0x2e, 0x6b, 0x65, 0x79, 0x5f, 0x6d, 0x6f,
	0x64, 0x65, 0x20, 0x3d, 0x3d, 0x20, 0x32, 0x20, 0x26, 0x26, 0x20, 0x74, 0x68, 0x69, 0x73, 0x2e,
	...
	0x27, 0x29, 0x1a, 0xb6, 0x01, 0x0a, 0x27, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x66, 0x65, 0x72,
	0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x5f, 0x69, 0x64, 0x5f, 0x6f, 0x70, 0x74, 0x69, 0x6f,
	0x6e, 0x61, 0x6c, 0x6c, 0x79, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x12, 0x3a,
	...
	0x66, 0x20, 0x74, 0x68, 0x65, 0x20, 0x6b, 0x65, 0x79, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x20, 0x69,
	0x73, 0x20, 0x52, 0x45, 0x4d, 0x4f, 0x54, 0x45, 0x2e, 0x20, 0x1a, 0x4f, 0x28, 0x28, 0x74, 0x68,
	0x69, 0x73, 0x2e, 0x6b, 0x65, 0x79, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x20, 0x3d, 0x3d, 0x20, 0x31,
	0x29, 0x20, 0x7c, 0x7c, 0x20, 0x28, 0x74, 0x68, 0x69, 0x73, 0x2e, 0x6b, 0x65, 0x79, 0x5f, 0x6d,
	0x6f, 0x64, 0x65, 0x20, 0x3d, 0x3d, 0x20, 0x32, 0x20, 0x26, 0x26, 0x20, 0x74, 0x68, 0x69, 0x73,
	0x2e, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x5f, 0x69, 0x64, 0x20, 0x21, 0x3d, 0x20, 0x27, 0x27, 0x29, 0x29, 0x22, 0x3c, 0x0a, 0x11, 0x43,
	...
	0x79, 0x52, 0x06, 0x6b, 0x61, 0x73, 0x4b, 0x65, 0x79, 0x22, 0x7a, 0x0a, 0x0d, 0x47, 0x65, 0x74,
	...
	0xba, 0x48, 0x02, 0x08, 0x01, 0x22, 0x39, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x4b, 0x65, 0x79, 0x52,
	...
	,
	...
	0x6c, 0x74, 0x65, 0x72, 0x22, 0x73, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x4b, 0x65, 0x79, 0x73,
	...
	0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xce, 0x04, 0x0a, 0x10, 0x55, 0x70,
	...
	0x03, 0xb0, 0x01, 0x01, 0x52, 0x02, 0x69, 0x64, 0x12, 0x3a, 0x0a, 0x0a, 0x6b, 0x65, 0x79, 0x5f,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x70,
	0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x4b, 0x65, 0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42,
	0x08, 0xba, 0x48, 0x05, 0x82, 0x01, 0x02, 0x10, 0x01, 0x52, 0x09, 0x6b, 0x65, 0x79, 0x53, 0x74,
	...
	,
	...
	,
	...
	0x12, 0x38, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e,
	...
	0x69, 0x65, 0x72, 0x48, 0x00, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x44, 0x0a, 0x07, 0x6e, 0x65,
	0x77, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x70, 0x6f,
	...
	0x74, 0x2e, 0x4e, 0x65, 0x77, 0x4b, 0x65, 0x79, 0x52, 0x06, 0x6e, 0x65, 0x77, 0x4b, 0x65, 0x79,
	0x1a, 0x8d, 0x03, 0x0a, 0x06, 0x4e, 0x65, 0x77, 0x4b, 0x65, 0x79, 0x12, 0x1e, 0x0a, 0x06, 0x6b,
	0x65, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x07, 0xba, 0x48, 0x04,
	0x72, 0x02, 0x10, 0x01, 0x52, 0x05, 0x6b, 0x65, 0x79, 0x49, 0x64, 0x12, 0x39, 0x0a, 0x09, 0x61,
	...
	0x6d, 0x42, 0x08, 0xba, 0x48, 0x05, 0x82, 0x01, 0x02, 0x10, 0x01, 0x52, 0x09, 0x61, 0x6c, 0x67,
	0x6f, 0x72, 0x69, 0x74, 0x68, 0x6d, 0x12, 0x34, 0x0a, 0x08, 0x6b, 0x65, 0x79, 0x5f, 0x6d, 0x6f,
	0x64, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0f, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63,
	0x79, 0x2e, 0x4b, 0x65, 0x79, 0x4d, 0x6f, 0x64, 0x65, 0x42, 0x08, 0xba, 0x48, 0x05, 0x82, 0x01,
	0x02, 0x10, 0x01, 0x52, 0x07, 0x6b, 0x65, 0x79, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x45, 0x0a, 0x0e,
	...
	0x73, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x43, 0x74, 0x78, 0x42, 0x06, 0xba,
	0x48, 0x03, 0xc8, 0x01, 0x01, 0x52, 0x0c, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79,
	0x43, 0x74, 0x78, 0x12, 0x48, 0x0a, 0x0f, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x5f, 0x6b,
	0x65, 0x79, 0x5f, 0x63, 0x74, 0x78, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x70,
	0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x4b, 0x61, 0x73, 0x50, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65,
	0x4b, 0x65, 0x79, 0x43, 0x74, 0x78, 0x42, 0x06, 0xba, 0x48, 0x03, 0xc8, 0x01, 0x01, 0x52, 0x0d,
	...
	0x3a, 0xac, 0x04, 0xba, 0x48, 0xa8, 0x04, 0x1a, 0xd4, 0x02, 0x0a, 0x23, 0x70, 0x72, 0x69, 0x76,
	...
	,
	...
	0x79, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x20, 0x3d, 0x3d, 0x20, 0x32, 0x20, 0x26, 0x26, 0x20, 0x74,
	...
	,
	...
	0x22, 0xc5, 0x01, 0x0a, 0x14, 0x53, 0x65, 0x74, 0x44, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x4b,
	...
	0x42, 0x0a, 0x08, 0x74, 0x64, 0x66, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x1b, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x6b, 0x61, 0x73, 0x72, 0x65,
	0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x2e, 0x54, 0x64, 0x66, 0x54, 0x79, 0x70, 0x65, 0x42, 0x0a,
	0xba, 0x48, 0x07, 0x82, 0x01, 0x04, 0x18, 0x01, 0x18, 0x02, 0x52, 0x07, 0x74, 0x64, 0x66, 0x54,
	0x79, 0x70, 0x65, 0x42, 0x13, 0x0a, 0x0a, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x5f, 0x6b, 0x65,
	0x79, 0x12, 0x05, 0xba, 0x48, 0x02, 0x08, 0x01, 0x22, 0x57, 0x0a, 0x13, 0x44, 0x65, 0x66, 0x61,
	0x75, 0x6c, 0x74, 0x4b, 0x61, 0x73, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x12,
	...
	,
	...
	0x01, 0x12, 0x98, 0x01, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x4b, 0x65, 0x79, 0x41, 0x63, 0x63, 0x65,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x23, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x1a, 0x12,
	0x18, 0x2f, 0x6b, 0x65, 0x79, 0x2d, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x2d, 0x73, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x73, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x90, 0x02, 0x01, 0x12, 0x9c, 0x01, 0x0a,
	...
	0x76, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x1e, 0x82, 0xd3, 0xe4,
	0x93, 0x02, 0x18, 0x3a, 0x01, 0x2a, 0x22, 0x13, 0x2f, 0x6b, 0x65, 0x79, 0x2d, 0x61, 0x63, 0x63,
	0x65, 0x73, 0x73, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x12, 0xa1, 0x01, 0x0a, 0x15,
	...
	0x02, 0x1d, 0x3a, 0x01, 0x2a, 0x32, 0x18, 0x2f, 0x6b, 0x65, 0x79, 0x2d, 0x61, 0x63, 0x63, 0x65,
	0x73, 0x73, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x12,
	0x9e, 0x01, 0x0a, 0x15, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x41, 0x63, 0x63,
	...
	0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x20,
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x1a, 0x2a, 0x18, 0x2f, 0x6b, 0x65, 0x79, 0x2d, 0x61, 0x63, 0x63,
	0x65, 0x73, 0x73, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x2f, 0x7b, 0x69, 0x64, 0x7d,
	0x12, 0xaf, 0x01, 0x0a, 0x19, 0x4c, 0x69, 0x73, 0x74, 0x4b, 0x65, 0x79, 0x41, 0x63, 0x63, 0x65,
	...
	0x93, 0x02, 0x1c, 0x12, 0x1a, 0x2f, 0x6b, 0x65, 0x79, 0x2d, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73,
	0x2d, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x2f, 0x67, 0x72, 0x61, 0x6e, 0x74, 0x73, 0x90,
	...
	,
...
var file_policy_kasregistry_key_access_server_registry_proto_goTypes = []interface{}{
	(TdfType)(0),                                          // 0: policy.kasregistry.TdfType
	...
	(*ListKeyAccessServersRequest)(nil),                   // 3: policy.kasregistry.ListKeyAccessServersRequest
	(*ListKeyAccessServersResponse)(nil),                  // 4: policy.kasregistry.ListKeyAccessServersResponse
	(*CreateKeyAccessServerRequest)(nil),                  // 5: policy.kasregistry.CreateKeyAccessServerRequest
	(*CreateKeyAccessServerResponse)(nil),                 // 6: policy.kasregistry.CreateKeyAccessServerResponse
	(*UpdateKeyAccessServerRequest)(nil),                  // 7: policy.kasregistry.UpdateKeyAccessServerRequest
	(*UpdateKeyAccessServerResponse)(nil),                 // 8: policy.kasregistry.UpdateKeyAccessServerResponse
	(*DeleteKeyAccessServerRequest)(nil),                  // 9: policy.kasregistry.DeleteKeyAccessServerRequest
	(*DeleteKeyAccessServerResponse)(nil),                 // 10: policy.kasregistry.DeleteKeyAccessServerResponse
	(*GrantedPolicyObject)(nil),                           // 11: policy.kasregistry.GrantedPolicyObject
	(*KeyAccessServerGrants)(nil),                         // 12: policy.kasregistry.KeyAccessServerGrants
	(*CreatePublicKeyRequest)(nil),                        // 13: policy.kasregistry.CreatePublicKeyRequest
	(*CreatePublicKeyResponse)(nil),                       // 14: policy.kasregistry.CreatePublicKeyResponse
	(*GetPublicKeyRequest)(nil),                           // 15: policy.kasregistry.GetPublicKeyRequest
	(*GetPublicKeyResponse)(nil),                          // 16: policy.kasregistry.GetPublicKeyResponse
	(*ListPublicKeysRequest)(nil),                         // 17: policy.kasregistry.ListPublicKeysRequest
	(*ListPublicKeysResponse)(nil),                        // 18: policy.kasregistry.ListPublicKeysResponse
	(*ListPublicKeyMappingRequest)(nil),                   // 19: policy.kasregistry.ListPublicKeyMappingRequest
	(*ListPublicKeyMappingResponse)(nil),                  // 20: policy.kasregistry.ListPublicKeyMappingResponse
	(*UpdatePublicKeyRequest)(nil),                        // 21: policy.kasregistry.UpdatePublicKeyRequest
	(*UpdatePublicKeyResponse)(nil),                       // 22: policy.kasregistry.UpdatePublicKeyResponse
	(*DeactivatePublicKeyRequest)(nil),                    // 23: policy.kasregistry.DeactivatePublicKeyRequest
	(*DeactivatePublicKeyResponse)(nil),                   // 24: policy.kasregistry.DeactivatePublicKeyResponse
	(*ActivatePublicKeyRequest)(nil),                      // 25: policy.kasregistry.ActivatePublicKeyRequest
	(*ActivatePublicKeyResponse)(nil),                     // 26: policy.kasregistry.ActivatePublicKeyResponse
	(*ListKeyAccessServerGrantsRequest)(nil),              // 27: policy.kasregistry.ListKeyAccessServerGrantsRequest
	(*ListKeyAccessServerGrantsResponse)(nil),             // 28: policy.kasregistry.ListKeyAccessServerGrantsResponse
	(*CreateKeyRequest)(nil),                              // 29: policy.kasregistry.CreateKeyRequest
	(*CreateKeyResponse)(nil),                             // 30: policy.kasregistry.CreateKeyResponse
	(*GetKeyRequest)(nil),                                 // 31: policy.kasregistry.GetKeyRequest
	(*GetKeyResponse)(nil),                                // 32: policy.kasregistry.GetKeyResponse
	(*ListKeysRequest)(nil),                               // 33: policy.kasregistry.ListKeysRequest
	(*ListKeysResponse)(nil),                              // 34: policy.kasregistry.ListKeysResponse
	(*UpdateKeyRequest)(nil),                              // 35: policy.kasregistry.UpdateKeyRequest
	(*UpdateKeyResponse)(nil),                             // 36: policy.kasregistry.UpdateKeyResponse
	(*KasKeyIdentifier)(nil),                              // 37: policy.kasregistry.KasKeyIdentifier
	(*RotateKeyRequest)(nil),                              // 38: policy.kasregistry.RotateKeyRequest
	(*ChangeMappings)(nil),                                // 39: policy.kasregistry.ChangeMappings
	(*RotatedResources)(nil),                              // 40: policy.kasregistry.RotatedResources
	(*RotateKeyResponse)(nil),                             // 41: policy.kasregistry.RotateKeyResponse
	(*SetDefaultKeyRequest)(nil),                          // 42: policy.kasregistry.SetDefaultKeyRequest
	(*DefaultKasPublicKey)(nil),                           // 43: policy.kasregistry.DefaultKasPublicKey
	(*DefaultKasKey)(nil),                                 // 44: policy.kasregistry.DefaultKasKey
	(*GetDefaultKeysRequest)(nil),                         // 45: policy.kasregistry.GetDefaultKeysRequest
	(*GetDefaultKeysResponse)(nil),                        // 46: policy.kasregistry.GetDefaultKeysResponse
	(*SetDefaultKeyResponse)(nil),                         // 47: policy.kasregistry.SetDefaultKeyResponse
	(*ListPublicKeyMappingResponse_PublicKeyMapping)(nil), // 48: policy.kasregistry.ListPublicKeyMappingResponse.PublicKeyMapping
	(*ListPublicKeyMappingResponse_PublicKey)(nil),        // 49: policy.kasregistry.ListPublicKeyMappingResponse.PublicKey
	(*ListPublicKeyMappingResponse_Association)(nil),      // 50: policy.kasregistry.ListPublicKeyMappingResponse.Association
	(*RotateKeyRequest_NewKey)(nil),                       // 51: policy.kasregistry.RotateKeyRequest.NewKey
	(*policy.KeyAccessServer)(nil),                        // 52: policy.KeyAccessServer
	(*policy.PageRequest)(nil),                            // 53: policy.PageRequest
	(*policy.PageResponse)(nil),                           // 54: policy.PageResponse
	(*policy.PublicKey)(nil),                              // 55: policy.PublicKey
	(policy.SourceType)(0),                                // 56: policy.SourceType
	(*common.MetadataMutable)(nil),                        // 57: common.MetadataMutable
	(common.MetadataUpdateEnum)(0),                        // 58: common.MetadataUpdateEnum
	(*policy.KasPublicKey)(nil),                           // 59: policy.KasPublicKey
	(*policy.Key)(nil),                                    // 60: policy.Key
	(policy.Algorithm)(0),                                 // 61: policy.Algorithm
	(policy.KeyMode)(0),                                   // 62: policy.KeyMode
	(*policy.KasPublicKeyCtx)(nil),                        // 63: policy.KasPublicKeyCtx
	(*policy.KasPrivateKeyCtx)(nil),                       // 64: policy.KasPrivateKeyCtx
	(*policy.KasKey)(nil),                                 // 65: policy.KasKey
	(policy.KeyStatus)(0),                                 // 66: policy.KeyStatus
}
var file_policy_kasregistry_key_access_server_registry_proto_depIdxs = []int32{
	52, // 0: policy.kasregistry.GetKeyAccessServerResponse.key_access_server:type_name -> policy.KeyAccessServer
	53, // 1: policy.kasregistry.ListKeyAccessServersRequest.pagination:type_name -> policy.PageRequest
	52, // 2: policy.kasregistry.ListKeyAccessServersResponse.key_access_servers:type_name -> policy.KeyAccessServer
	54, // 3: policy.kasregistry.ListKeyAccessServersResponse.pagination:type_name -> policy.PageResponse
	55, // 4: policy.kasregistry.CreateKeyAccessServerRequest.public_key:type_name -> policy.PublicKey
	56, // 5: policy.kasregistry.CreateKeyAccessServerRequest.source_type:type_name -> policy.SourceType
	57, // 6: policy.kasregistry.CreateKeyAccessServerRequest.metadata:type_name -> common.MetadataMutable
	52, // 7: policy.kasregistry.CreateKeyAccessServerResponse.key_access_server:type_name -> policy.KeyAccessServer
	55, // 8: policy.kasregistry.UpdateKeyAccessServerRequest.public_key:type_name -> policy.PublicKey
	56, // 9: policy.kasregistry.UpdateKeyAccessServerRequest.source_type:type_name -> policy.SourceType
	57, // 10: policy.kasregistry.UpdateKeyAccessServerRequest.metadata:type_name -> common.MetadataMutable
	58, // 11: policy.kasregistry.UpdateKeyAccessServerRequest.metadata_update_behavior:type_name -> common.MetadataUpdateEnum
	52, // 12: policy.kasregistry.UpdateKeyAccessServerResponse.key_access_server:type_name -> policy.KeyAccessServer
	52, // 13: policy.kasregistry.DeleteKeyAccessServerResponse.key_access_server:type_name -> policy.KeyAccessServer
	52, // 14: policy.kasregistry.KeyAccessServerGrants.key_access_server:type_name -> policy.KeyAccessServer
	11, // 15: policy.kasregistry.KeyAccessServerGrants.namespace_grants:type_name -> policy.kasregistry.GrantedPolicyObject
	11, // 16: policy.kasregistry.KeyAccessServerGrants.attribute_grants:type_name -> policy.kasregistry.GrantedPolicyObject
	11, // 17: policy.kasregistry.KeyAccessServerGrants.value_grants:type_name -> policy.kasregistry.GrantedPolicyObject
	59, // 18: policy.kasregistry.CreatePublicKeyRequest.key:type_name -> policy.KasPublicKey
	57, // 19: policy.kasregistry.CreatePublicKeyRequest.metadata:type_name -> common.MetadataMutable
	60, // 20: policy.kasregistry.CreatePublicKeyResponse.key:type_name -> policy.Key
	60, // 21: policy.kasregistry.GetPublicKeyResponse.key:type_name -> policy.Key
	53, // 22: policy.kasregistry.ListPublicKeysRequest.pagination:type_name -> policy.PageRequest
	60, // 23: policy.kasregistry.ListPublicKeysResponse.keys:type_name -> policy.Key
	54, // 24: policy.kasregistry.ListPublicKeysResponse.pagination:type_name -> policy.PageResponse
	53, // 25: policy.kasregistry.ListPublicKeyMappingRequest.pagination:type_name -> policy.PageRequest
	48, // 26: policy.kasregistry.ListPublicKeyMappingResponse.public_key_mappings:type_name -> policy.kasregistry.ListPublicKeyMappingResponse.PublicKeyMapping
	54, // 27: policy.kasregistry.ListPublicKeyMappingResponse.pagination:type_name -> policy.PageResponse
	57, // 28: policy.kasregistry.UpdatePublicKeyRequest.metadata:type_name -> common.MetadataMutable
	58, // 29: policy.kasregistry.UpdatePublicKeyRequest.metadata_update_behavior:type_name -> common.MetadataUpdateEnum
	60, // 30: policy.kasregistry.UpdatePublicKeyResponse.key:type_name -> policy.Key
	60, // 31: policy.kasregistry.DeactivatePublicKeyResponse.key:type_name -> policy.Key
	60, // 32: policy.kasregistry.ActivatePublicKeyResponse.key:type_name -> policy.Key
	53, // 33: policy.kasregistry.ListKeyAccessServerGrantsRequest.pagination:type_name -> policy.PageRequest
	12, // 34: policy.kasregistry.ListKeyAccessServerGrantsResponse.grants:type_name -> policy.kasregistry.KeyAccessServerGrants
	54, // 35: policy.kasregistry.ListKeyAccessServerGrantsResponse.pagination:type_name -> policy.PageResponse
	61, // 36: policy.kasregistry.CreateKeyRequest.key_algorithm:type_name -> policy.Algorithm
	62, // 37: policy.kasregistry.CreateKeyRequest.key_mode:type_name -> policy.KeyMode
	63, // 38: policy.kasregistry.CreateKeyRequest.public_key_ctx:type_name -> policy.KasPublicKeyCtx
	64, // 39: policy.kasregistry.CreateKeyRequest.private_key_ctx:type_name -> policy.KasPrivateKeyCtx
	57, // 40: policy.kasregistry.CreateKeyRequest.metadata:type_name -> common.MetadataMutable
	65, // 41: policy.kasregistry.CreateKeyResponse.kas_key:type_name -> policy.KasKey
	37, // 42: policy.kasregistry.GetKeyRequest.key:type_name -> policy.kasregistry.KasKeyIdentifier
	65, // 43: policy.kasregistry.GetKeyResponse.kas_key:type_name -> policy.KasKey
	61, // 44: policy.kasregistry.ListKeysRequest.key_algorithm:type_name -> policy.Algorithm
	53, // 45: policy.kasregistry.ListKeysRequest.pagination:type_name -> policy.PageRequest
	65, // 46: policy.kasregistry.ListKeysResponse.kas_keys:type_name -> policy.KasKey
	54, // 47: policy.kasregistry.ListKeysResponse.pagination:type_name -> policy.PageResponse
	66, // 48: policy.kasregistry.UpdateKeyRequest.key_status:type_name -> policy.KeyStatus
	57, // 49: policy.kasregistry.UpdateKeyRequest.metadata:type_name -> common.MetadataMutable
	58, // 50: policy.kasregistry.UpdateKeyRequest.metadata_update_behavior:type_name -> common.MetadataUpdateEnum
	65, // 51: policy.kasregistry.UpdateKeyResponse.kas_key:type_name -> policy.KasKey
	37, // 52: policy.kasregistry.RotateKeyRequest.key:type_name -> policy.kasregistry.KasKeyIdentifier
	51, // 53: policy.kasregistry.RotateKeyRequest.new_key:type_name -> policy.kasregistry.RotateKeyRequest.NewKey
	65, // 54: policy.kasregistry.RotatedResources.rotated_out_key:type_name -> policy.KasKey
	39, // 55: policy.kasregistry.RotatedResources.attribute_definition_mappings:type_name -> policy.kasregistry.ChangeMappings
	39, // 56: policy.kasregistry.RotatedResources.attribute_value_mappings:type_name -> policy.kasregistry.ChangeMappings
	39, // 57: policy.kasregistry.RotatedResources.namespace_mappings:type_name -> policy.kasregistry.ChangeMappings
	65, // 58: policy.kasregistry.RotateKeyResponse.kas_key:type_name -> policy.KasKey
	40, // 59: policy.kasregistry.RotateKeyResponse.rotated_resources:type_name -> policy.kasregistry.RotatedResources
	37, // 60: policy.kasregistry.SetDefaultKeyRequest.key:type_name -> policy.kasregistry.KasKeyIdentifier
	0,  // 61: policy.kasregistry.SetDefaultKeyRequest.tdf_type:type_name -> policy.kasregistry.TdfType
	43, // 62: policy.kasregistry.DefaultKasKey.public_key:type_name -> policy.kasregistry.DefaultKasPublicKey
	44, // 63: policy.kasregistry.GetDefaultKeysResponse.default_kas_keys:type_name -> policy.kasregistry.DefaultKasKey
	44, // 64: policy.kasregistry.SetDefaultKeyResponse.new_default_kas_key:type_name -> policy.kasregistry.DefaultKasKey
	44, // 65: policy.kasregistry.SetDefaultKeyResponse.previous_default_kas_key:type_name -> policy.kasregistry.DefaultKasKey
	49, // 66: policy.kasregistry.ListPublicKeyMappingResponse.PublicKeyMapping.public_keys:type_name -> policy.kasregistry.ListPublicKeyMappingResponse.PublicKey
	60, // 67: policy.kasregistry.ListPublicKeyMappingResponse.PublicKey.key:type_name -> policy.Key
	50, // 68: policy.kasregistry.ListPublicKeyMappingResponse.PublicKey.values:type_name -> policy.kasregistry.ListPublicKeyMappingResponse.Association
	50, // 69: policy.kasregistry.ListPublicKeyMappingResponse.PublicKey.definitions:type_name -> policy.kasregistry.ListPublicKeyMappingResponse.Association
	50, // 70: policy.kasregistry.ListPublicKeyMappingResponse.PublicKey.namespaces:type_name -> policy.kasregistry.ListPublicKeyMappingResponse.Association
	61, // 71: policy.kasregistry.RotateKeyRequest.NewKey.algorithm:type_name -> policy.Algorithm
	62, // 72: policy.kasregistry.RotateKeyRequest.NewKey.key_mode:type_name -> policy.KeyMode
	63, // 73: policy.kasregistry.RotateKeyRequest.NewKey.public_key_ctx:type_name -> policy.KasPublicKeyCtx
	64, // 74: policy.kasregistry.RotateKeyRequest.NewKey.private_key_ctx:type_name -> policy.KasPrivateKeyCtx
	57, // 75: policy.kasregistry.RotateKeyRequest.NewKey.metadata:type_name -> common.MetadataMutable
	3,  // 76: policy.kasregistry.KeyAccessServerRegistryService.ListKeyAccessServers:input_type -> policy.kasregistry.ListKeyAccessServersRequest
	1,  // 77: policy.kasregistry.KeyAccessServerRegistryService.GetKeyAccessServer:input_type -> policy.kasregistry.GetKeyAccessServerRequest
	5,  // 78: policy.kasregistry.KeyAccessServerRegistryService.CreateKeyAccessServer:input_type -> policy.kasregistry.CreateKeyAccessServerRequest
	7,  // 79: policy.kasregistry.KeyAccessServerRegistryService.UpdateKeyAccessServer:input_type -> policy.kasregistry.UpdateKeyAccessServerRequest
	9,  // 80: policy.kasregistry.KeyAccessServerRegistryService.DeleteKeyAccessServer:input_type -> policy.kasregistry.DeleteKeyAccessServerRequest
	27, // 81: policy.kasregistry.KeyAccessServerRegistryService.ListKeyAccessServerGrants:input_type -> policy.kasregistry.ListKeyAccessServerGrantsRequest
	29, // 82: policy.kasregistry.KeyAccessServerRegistryService.CreateKey:input_type -> policy.kasregistry.CreateKeyRequest
	31, // 83: policy.kasregistry.KeyAccessServerRegistryService.GetKey:input_type -> policy.kasregistry.GetKeyRequest
	33, // 84: policy.kasregistry.KeyAccessServerRegistryService.ListKeys:input_type -> policy.kasregistry.ListKeysRequest
	35, // 85: policy.kasregistry.KeyAccessServerRegistryService.UpdateKey:input_type -> policy.kasregistry.UpdateKeyRequest
	38, // 86: policy.kasregistry.KeyAccessServerRegistryService.RotateKey:input_type -> policy.kasregistry.RotateKeyRequest
	42, // 87: policy.kasregistry.KeyAccessServerRegistryService.SetDefaultKey:input_type -> policy.kasregistry.SetDefaultKeyRequest
	45, // 88: policy.kasregistry.KeyAccessServerRegistryService.GetDefaultKeys:input_type -> policy.kasregistry.GetDefaultKeysRequest
	4,  // 89: policy.kasregistry.KeyAccessServerRegistryService.ListKeyAccessServers:output_type -> policy.kasregistry.ListKeyAccessServersResponse
	2,  // 90: policy.kasregistry.KeyAccessServerRegistryService.GetKeyAccessServer:output_type -> policy.kasregistry.GetKeyAccessServerResponse
	6,  // 91: policy.kasregistry.KeyAccessServerRegistryService.CreateKeyAccessServer:output_type -> policy.kasregistry.CreateKeyAccessServerResponse
	8,  // 92: policy.kasregistry.KeyAccessServerRegistryService.UpdateKeyAccessServer:output_type -> policy.kasregistry.UpdateKeyAccessServerResponse
	10, // 93: policy.kasregistry.KeyAccessServerRegistryService.DeleteKeyAccessServer:output_type -> policy.kasregistry.DeleteKeyAccessServerResponse
	28, // 94: policy.kasregistry.KeyAccessServerRegistryService.ListKeyAccessServerGrants:output_type -> policy.kasregistry.ListKeyAccessServerGrantsResponse
	30, // 95: policy.kasregistry.KeyAccessServerRegistryService.CreateKey:output_type -> policy.kasregistry.CreateKeyResponse
	32, // 96: policy.kasregistry.KeyAccessServerRegistryService.GetKey:output_type -> policy.kasregistry.GetKeyResponse
	34, // 97: policy.kasregistry.KeyAccessServerRegistryService.ListKeys:output_type -> policy.kasregistry.ListKeysResponse
	36, // 98: policy.kasregistry.KeyAccessServerRegistryService.UpdateKey:output_type -> policy.kasregistry.UpdateKeyResponse
	41, // 99: policy.kasregistry.KeyAccessServerRegistryService.RotateKey:output_type -> policy.kasregistry.RotateKeyResponse
	47, // 100: policy.kasregistry.KeyAccessServerRegistryService.SetDefaultKey:output_type -> policy.kasregistry.SetDefaultKeyResponse
	46, // 101: policy.kasregistry.KeyAccessServerRegistryService.GetDefaultKeys:output_type -> policy.kasregistry.GetDefaultKeysResponse
...
func file_policy_kasregistry_key_access_server_registry_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_policy_kasregistry_key_access_server_registry_proto_msgTypes[42].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DefaultKasPublicKey); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_policy_kasregistry_key_access_server_registry_proto_msgTypes[44].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetDefaultKeysRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_policy_kasregistry_key_access_server_registry_proto_msgTypes[45].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetDefaultKeysResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_policy_kasregistry_key_access_server_registry_proto_msgTypes[46].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SetDefaultKeyResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_policy_kasregistry_key_access_server_registry_proto_msgTypes[41].OneofWrappers = []interface{}{
		(*SetDefaultKeyRequest_Id)(nil),
		(*SetDefaultKeyRequest_Key)(nil),
	}
	type x struct{}
