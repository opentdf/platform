...
var file_policy_kasregistry_key_access_server_registry_proto_rawDesc = []byte{
	...
	0x08, 0x01, 0x22, 0x3c, 0x0a, 0x11, 0x52, 0x6f, 0x74, 0x61, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x52,
...
var file_policy_kasregistry_key_access_server_registry_proto_goTypes = []interface{}{
	...
	(*policy.KasKey)(nil),                                 // 54: policy.KasKey
...
var file_policy_kasregistry_key_access_server_registry_proto_depIdxs = []int32{
	...
	54, // 39: policy.kasregistry.CreateKeyResponse.kas_key:type_name -> policy.KasKey
	36, // 40: policy.kasregistry.GetKeyRequest.key:type_name -> policy.kasregistry.KasKeyIdentifier
	54, // 41: policy.kasregistry.GetKeyResponse.kas_key:type_name -> policy.KasKey
	...
	54, // 44: policy.kasregistry.ListKeysResponse.kas_keys:type_name -> policy.KasKey
	...
	54, // 49: policy.kasregistry.UpdateKeyResponse.kas_key:type_name -> policy.KasKey
	...
	54, // 52: policy.kasregistry.RotateKeyResponse.kas_key:type_name -> policy.KasKey
	...
	48, // 60: policy.kasregistry.RotateKeyRequest.NewKey.metadata:type_name -> common.MetadataMutable
