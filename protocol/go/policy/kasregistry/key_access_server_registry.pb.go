...
var file_policy_kasregistry_key_access_server_registry_proto_rawDesc = []byte{
	...
	0x82, 0x04, 0x0a, 0x10, 0x52, 0x6f, 0x74, 0x61, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x52, 0x65, 0x71,
	...
	0x1a, 0xc3, 0x02, 0x0a, 0x06, 0x4e, 0x65, 0x77, 0x4b, 0x65, 0x79, 0x12, 0x1e, 0x0a, 0x06, 0x6b,
	...
	0x02, 0x10, 0x01, 0x52, 0x07, 0x6b, 0x65, 0x79, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x26, 0x0a, 0x0f,
	0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x5f, 0x6b, 0x65, 0x79, 0x5f, 0x63, 0x74, 0x78, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0d, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x4b, 0x65,
	0x79, 0x43, 0x74, 0x78, 0x12, 0x24, 0x0a, 0x0e, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x5f, 0x6b,
	0x65, 0x79, 0x5f, 0x63, 0x74, 0x78, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0c, 0x70, 0x75,
	...
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x49, 0x64, 0x12, 0x2c, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61,
	...
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x42, 0x0c, 0x0a, 0x0a, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65,
	0x5f, 0x6b, 0x65, 0x79, 0x22, 0x3c, 0x0a, 0x11, 0x52, 0x6f, 0x74, 0x61, 0x74, 0x65, 0x4b, 0x65,
	...
	0x65, 0x79, 0x32, 0xad, 0x0b, 0x0a, 0x1e, 0x4b, 0x65, 0x79, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73,
...
var file_policy_kasregistry_key_access_server_registry_proto_goTypes = []interface{}{
	...
	(*RotateKeyResponse)(nil),                             // 38: policy.kasregistry.RotateKeyResponse
	(*ListPublicKeyMappingResponse_PublicKeyMapping)(nil), // 39: policy.kasregistry.ListPublicKeyMappingResponse.PublicKeyMapping
	(*ListPublicKeyMappingResponse_PublicKey)(nil),        // 40: policy.kasregistry.ListPublicKeyMappingResponse.PublicKey
	(*ListPublicKeyMappingResponse_Association)(nil),      // 41: policy.kasregistry.ListPublicKeyMappingResponse.Association
	...
	(*policy.KasPublicKeyCtx)(nil),                        // 54: policy.KasPublicKeyCtx
	(*policy.KasPrivateKeyCtx)(nil),                       // 55: policy.KasPrivateKeyCtx
	(*policy.KasKey)(nil),                                 // 56: policy.KasKey
	(policy.KeyStatus)(0),                                 // 57: policy.KeyStatus
	(*common.Metadata)(nil),                               // 58: common.Metadata
}
var file_policy_kasregistry_key_access_server_registry_proto_depIdxs = []int32{
	...
	39, // 26: policy.kasregistry.ListPublicKeyMappingResponse.public_key_mappings:type_name -> policy.kasregistry.ListPublicKeyMappingResponse.PublicKeyMapping
	...
	54, // 38: policy.kasregistry.CreateKeyRequest.public_key_ctx:type_name -> policy.KasPublicKeyCtx
	55, // 39: policy.kasregistry.CreateKeyRequest.private_key_ctx:type_name -> policy.KasPrivateKeyCtx
	48, // 40: policy.kasregistry.CreateKeyRequest.metadata:type_name -> common.MetadataMutable
	56, // 41: policy.kasregistry.CreateKeyResponse.kas_key:type_name -> policy.KasKey
	36, // 42: policy.kasregistry.GetKeyRequest.key:type_name -> policy.kasregistry.KasKeyIdentifier
	56, // 43: policy.kasregistry.GetKeyResponse.kas_key:type_name -> policy.KasKey
	52, // 44: policy.kasregistry.ListKeysRequest.key_algorithm:type_name -> policy.Algorithm
	44, // 45: policy.kasregistry.ListKeysRequest.pagination:type_name -> policy.PageRequest
	56, // 46: policy.kasregistry.ListKeysResponse.kas_keys:type_name -> policy.KasKey
	45, // 47: policy.kasregistry.ListKeysResponse.pagination:type_name -> policy.PageResponse
	57, // 48: policy.kasregistry.UpdateKeyRequest.key_status:type_name -> policy.KeyStatus
	48, // 49: policy.kasregistry.UpdateKeyRequest.metadata:type_name -> common.MetadataMutable
	49, // 50: policy.kasregistry.UpdateKeyRequest.metadata_update_behavior:type_name -> common.MetadataUpdateEnum
	56, // 51: policy.kasregistry.UpdateKeyResponse.kas_key:type_name -> policy.KasKey
	36, // 52: policy.kasregistry.RotateKeyRequest.key:type_name -> policy.kasregistry.KasKeyIdentifier
	42, // 53: policy.kasregistry.RotateKeyRequest.new_key:type_name -> policy.kasregistry.RotateKeyRequest.NewKey
	56, // 54: policy.kasregistry.RotateKeyResponse.kas_key:type_name -> policy.KasKey
	40, // 55: policy.kasregistry.ListPublicKeyMappingResponse.PublicKeyMapping.public_keys:type_name -> policy.kasregistry.ListPublicKeyMappingResponse.PublicKey
	51, // 56: policy.kasregistry.ListPublicKeyMappingResponse.PublicKey.key:type_name -> policy.Key
	41, // 57: policy.kasregistry.ListPublicKeyMappingResponse.PublicKey.values:type_name -> policy.kasregistry.ListPublicKeyMappingResponse.Association
	41, // 58: policy.kasregistry.ListPublicKeyMappingResponse.PublicKey.definitions:type_name -> policy.kasregistry.ListPublicKeyMappingResponse.Association
	41, // 59: policy.kasregistry.ListPublicKeyMappingResponse.PublicKey.namespaces:type_name -> policy.kasregistry.ListPublicKeyMappingResponse.Association
	52, // 60: policy.kasregistry.RotateKeyRequest.NewKey.algorithm:type_name -> policy.Algorithm
	53, // 61: policy.kasregistry.RotateKeyRequest.NewKey.key_mode:type_name -> policy.KeyMode
	58, // 62: policy.kasregistry.RotateKeyRequest.NewKey.metadata:type_name -> common.Metadata
	2,  // 63: policy.kasregistry.KeyAccessServerRegistryService.ListKeyAccessServers:input_type -> policy.kasregistry.ListKeyAccessServersRequest
	0,  // 64: policy.kasregistry.KeyAccessServerRegistryService.GetKeyAccessServer:input_type -> policy.kasregistry.GetKeyAccessServerRequest
	4,  // 65: policy.kasregistry.KeyAccessServerRegistryService.CreateKeyAccessServer:input_type -> policy.kasregistry.CreateKeyAccessServerRequest
	6,  // 66: policy.kasregistry.KeyAccessServerRegistryService.UpdateKeyAccessServer:input_type -> policy.kasregistry.UpdateKeyAccessServerRequest
	8,  // 67: policy.kasregistry.KeyAccessServerRegistryService.DeleteKeyAccessServer:input_type -> policy.kasregistry.DeleteKeyAccessServerRequest
	26, // 68: policy.kasregistry.KeyAccessServerRegistryService.ListKeyAccessServerGrants:input_type -> policy.kasregistry.ListKeyAccessServerGrantsRequest
	28, // 69: policy.kasregistry.KeyAccessServerRegistryService.CreateKey:input_type -> policy.kasregistry.CreateKeyRequest
	30, // 70: policy.kasregistry.KeyAccessServerRegistryService.GetKey:input_type -> policy.kasregistry.GetKeyRequest
	32, // 71: policy.kasregistry.KeyAccessServerRegistryService.ListKeys:input_type -> policy.kasregistry.ListKeysRequest
	34, // 72: policy.kasregistry.KeyAccessServerRegistryService.UpdateKey:input_type -> policy.kasregistry.UpdateKeyRequest
	37, // 73: policy.kasregistry.KeyAccessServerRegistryService.RotateKey:input_type -> policy.kasregistry.RotateKeyRequest
	3,  // 74: policy.kasregistry.KeyAccessServerRegistryService.ListKeyAccessServers:output_type -> policy.kasregistry.ListKeyAccessServersResponse
	1,  // 75: policy.kasregistry.KeyAccessServerRegistryService.GetKeyAccessServer:output_type -> policy.kasregistry.GetKeyAccessServerResponse
	5,  // 76: policy.kasregistry.KeyAccessServerRegistryService.CreateKeyAccessServer:output_type -> policy.kasregistry.CreateKeyAccessServerResponse
	7,  // 77: policy.kasregistry.KeyAccessServerRegistryService.UpdateKeyAccessServer:output_type -> policy.kasregistry.UpdateKeyAccessServerResponse
	9,  // 78: policy.kasregistry.KeyAccessServerRegistryService.DeleteKeyAccessServer:output_type -> policy.kasregistry.DeleteKeyAccessServerResponse
	27, // 79: policy.kasregistry.KeyAccessServerRegistryService.ListKeyAccessServerGrants:output_type -> policy.kasregistry.ListKeyAccessServerGrantsResponse
	29, // 80: policy.kasregistry.KeyAccessServerRegistryService.CreateKey:output_type -> policy.kasregistry.CreateKeyResponse
	31, // 81: policy.kasregistry.KeyAccessServerRegistryService.GetKey:output_type -> policy.kasregistry.GetKeyResponse
	33, // 82: policy.kasregistry.KeyAccessServerRegistryService.ListKeys:output_type -> policy.kasregistry.ListKeysResponse
	35, // 83: policy.kasregistry.KeyAccessServerRegistryService.UpdateKey:output_type -> policy.kasregistry.UpdateKeyResponse
	38, // 84: policy.kasregistry.KeyAccessServerRegistryService.RotateKey:output_type -> policy.kasregistry.RotateKeyResponse
