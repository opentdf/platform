...
var file_policy_objects_proto_rawDesc = []byte{
	...
	0x35, 0x32, 0x31, 0x52, 0x31, 0x10, 0x07, 0x42, 0x82, 0x01, 0x0a, 0x0a, 0x63, 0x6f, 0x6d, 0x2e,
...
var file_policy_objects_proto_goTypes = []interface{}{
	...
	(*KeyProviderConfig)(nil),       // 5: policy.KeyProviderConfig
	(*Namespace)(nil),               // 6: policy.Namespace
	(*Attribute)(nil),               // 7: policy.Attribute
	(*Value)(nil),                   // 8: policy.Value
	(*Action)(nil),                  // 9: policy.Action
	(*SubjectMapping)(nil),          // 10: policy.SubjectMapping
	(*Condition)(nil),               // 11: policy.Condition
	(*ConditionGroup)(nil),          // 12: policy.ConditionGroup
	(*SubjectSet)(nil),              // 13: policy.SubjectSet
	(*SubjectConditionSet)(nil),     // 14: policy.SubjectConditionSet
	(*SubjectProperty)(nil),         // 15: policy.SubjectProperty
	(*ResourceMappingGroup)(nil),    // 16: policy.ResourceMappingGroup
	(*ResourceMapping)(nil),         // 17: policy.ResourceMapping
	(*KeyAccessServer)(nil),         // 18: policy.KeyAccessServer
	(*Key)(nil),                     // 19: policy.Key
	(*KasPublicKey)(nil),            // 20: policy.KasPublicKey
	(*KasPublicKeySet)(nil),         // 21: policy.KasPublicKeySet
	(*PublicKey)(nil),               // 22: policy.PublicKey
	(*RegisteredResource)(nil),      // 23: policy.RegisteredResource
	(*RegisteredResourceValue)(nil), // 24: policy.RegisteredResourceValue
...
var file_policy_objects_proto_depIdxs = []int32{
	25, // 0: policy.KeyProviderConfig.metadata:type_name -> common.Metadata
	26, // 1: policy.Namespace.active:type_name -> google.protobuf.BoolValue
	25, // 2: policy.Namespace.metadata:type_name -> common.Metadata
	18, // 3: policy.Namespace.grants:type_name -> policy.KeyAccessServer
	19, // 4: policy.Namespace.keys:type_name -> policy.Key
	6,  // 5: policy.Attribute.namespace:type_name -> policy.Namespace
	0,  // 6: policy.Attribute.rule:type_name -> policy.AttributeRuleTypeEnum
	8,  // 7: policy.Attribute.values:type_name -> policy.Value
	18, // 8: policy.Attribute.grants:type_name -> policy.KeyAccessServer
	26, // 9: policy.Attribute.active:type_name -> google.protobuf.BoolValue
	19, // 10: policy.Attribute.keys:type_name -> policy.Key
	25, // 11: policy.Attribute.metadata:type_name -> common.Metadata
	7,  // 12: policy.Value.attribute:type_name -> policy.Attribute
	18, // 13: policy.Value.grants:type_name -> policy.KeyAccessServer
	26, // 14: policy.Value.active:type_name -> google.protobuf.BoolValue
	10, // 15: policy.Value.subject_mappings:type_name -> policy.SubjectMapping
	19, // 16: policy.Value.keys:type_name -> policy.Key
	25, // 17: policy.Value.metadata:type_name -> common.Metadata
	4,  // 18: policy.Action.standard:type_name -> policy.Action.StandardAction
	25, // 19: policy.Action.metadata:type_name -> common.Metadata
	8,  // 20: policy.SubjectMapping.attribute_value:type_name -> policy.Value
	14, // 21: policy.SubjectMapping.subject_condition_set:type_name -> policy.SubjectConditionSet
	9,  // 22: policy.SubjectMapping.actions:type_name -> policy.Action
	25, // 23: policy.SubjectMapping.metadata:type_name -> common.Metadata
	1,  // 24: policy.Condition.operator:type_name -> policy.SubjectMappingOperatorEnum
	11, // 25: policy.ConditionGroup.conditions:type_name -> policy.Condition
	2,  // 26: policy.ConditionGroup.boolean_operator:type_name -> policy.ConditionBooleanTypeEnum
	12, // 27: policy.SubjectSet.condition_groups:type_name -> policy.ConditionGroup
	13, // 28: policy.SubjectConditionSet.subject_sets:type_name -> policy.SubjectSet
	25, // 29: policy.SubjectConditionSet.metadata:type_name -> common.Metadata
	25, // 30: policy.ResourceMappingGroup.metadata:type_name -> common.Metadata
	25, // 31: policy.ResourceMapping.metadata:type_name -> common.Metadata
	8,  // 32: policy.ResourceMapping.attribute_value:type_name -> policy.Value
	16, // 33: policy.ResourceMapping.group:type_name -> policy.ResourceMappingGroup
	22, // 34: policy.KeyAccessServer.public_key:type_name -> policy.PublicKey
	25, // 35: policy.KeyAccessServer.metadata:type_name -> common.Metadata
	26, // 36: policy.Key.is_active:type_name -> google.protobuf.BoolValue
	26, // 37: policy.Key.was_mapped:type_name -> google.protobuf.BoolValue
	20, // 38: policy.Key.public_key:type_name -> policy.KasPublicKey
	18, // 39: policy.Key.kas:type_name -> policy.KeyAccessServer
	25, // 40: policy.Key.metadata:type_name -> common.Metadata
	3,  // 41: policy.KasPublicKey.alg:type_name -> policy.KasPublicKeyAlgEnum
	20, // 42: policy.KasPublicKeySet.keys:type_name -> policy.KasPublicKey
	21, // 43: policy.PublicKey.cached:type_name -> policy.KasPublicKeySet
	24, // 44: policy.RegisteredResource.values:type_name -> policy.RegisteredResourceValue
	25, // 45: policy.RegisteredResource.metadata:type_name -> common.Metadata
	23, // 46: policy.RegisteredResourceValue.resource:type_name -> policy.RegisteredResource
	25, // 47: policy.RegisteredResourceValue.metadata:type_name -> common.Metadata
