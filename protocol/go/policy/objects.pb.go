...
const (
	...
	KasPublicKeyAlgEnum_KAS_PUBLIC_KEY_ALG_ENUM_HYBRID_XWING KasPublicKeyAlgEnum = 30
)
...
var (
	KasPublicKeyAlgEnum_name = map[int32]string{
		...
		30: "KAS_PUBLIC_KEY_ALG_ENUM_HYBRID_XWING",
	}
	KasPublicKeyAlgEnum_value = map[string]int32{
		...
		"KAS_PUBLIC_KEY_ALG_ENUM_HYBRID_XWING": 30,
	}
)
...
const (
	...
	Algorithm_ALGORITHM_HYBRID_XWING Algorithm = 30
)
...
var file_policy_objects_proto_rawDesc = []byte{
	...
	0x2a, 0x81, 0x03, 0x0a, 0x13, 0x4b, 0x61, 0x73, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65,
	...
	0x4b, 0x45, 0x4d, 0x5f, 0x31, 0x30, 0x32, 0x34, 0x10, 0x15, 0x12, 0x28, 0x0a, 0x24, 0x4b, 0x41,
	0x53, 0x5f, 0x50, 0x55, 0x42, 0x4c, 0x49, 0x43, 0x5f, 0x4b, 0x45, 0x59, 0x5f, 0x41, 0x4c, 0x47,
	0x5f, 0x45, 0x4e, 0x55, 0x4d, 0x5f, 0x48, 0x59, 0x42, 0x52, 0x49, 0x44, 0x5f, 0x58, 0x57, 0x49,
	0x4e, 0x47, 0x10, 0x1e, 0x2a, 0xea, 0x01, 0x0a, 0x09, 0x41, 0x6c, 0x67, 0x6f, 0x72, 0x69, 0x74,
	...
	0x10, 0x05, 0x12, 0x17, 0x0a, 0x13, 0x41, 0x4c, 0x47, 0x4f, 0x52, 0x49, 0x54, 0x48, 0x4d, 0x5f,
	...
	0x30, 0x32, 0x34, 0x10, 0x15, 0x12, 0x1a, 0x0a, 0x16, 0x41, 0x4c, 0x47, 0x4f, 0x52, 0x49, 0x54,
	0x48, 0x4d, 0x5f, 0x48, 0x59, 0x42, 0x52, 0x49, 0x44, 0x5f, 0x58, 0x57, 0x49, 0x4e, 0x47, 0x10,
	0x1e, 0x2a, 0x56, 0x0a, 0x09, 0x4b, 0x65, 0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1a,
...
var file_policy_objects_proto_depIdxs = []int32{
	...
	42, // 71: policy.ObligationTrigger.metadata:type_name -> common.Metadata
	39, // 72: policy.KasKey.key:type_name -> policy.AsymmetricKey
	5,  // 73: policy.AsymmetricKey.key_algorithm:type_name -> policy.Algorithm
	6,  // 74: policy.AsymmetricKey.key_status:type_name -> policy.KeyStatus
	7,  // 75: policy.AsymmetricKey.key_mode:type_name -> policy.KeyMode
	37, // 76: policy.AsymmetricKey.public_key_ctx:type_name -> policy.PublicKeyCtx
	38, // 77: policy.AsymmetricKey.private_key_ctx:type_name -> policy.PrivateKeyCtx
	11, // 78: policy.AsymmetricKey.provider_config:type_name -> policy.KeyProviderConfig
	42, // 79: policy.AsymmetricKey.metadata:type_name -> common.Metadata
	6,  // 80: policy.SymmetricKey.key_status:type_name -> policy.KeyStatus
	7,  // 81: policy.SymmetricKey.key_mode:type_name -> policy.KeyMode
	11, // 82: policy.SymmetricKey.provider_config:type_name -> policy.KeyProviderConfig
	42, // 83: policy.SymmetricKey.metadata:type_name -> common.Metadata
	15, // 84: policy.RegisteredResourceValue.ActionAttributeValue.action:type_name -> policy.Action
	14, // 85: policy.RegisteredResourceValue.ActionAttributeValue.attribute_value:type_name -> policy.Value
	42, // 86: policy.RegisteredResourceValue.ActionAttributeValue.metadata:type_name -> common.Metadata
