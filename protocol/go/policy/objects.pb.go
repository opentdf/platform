...
func (x *PublicKey) GetSet() *JWKSet {
	if x, ok := x.GetPublicKey().(*PublicKey_Set); ok {
		return x.Set
	}
	return nil
}
...
type PublicKey_Set struct {
	// Multiple keys with key ids
	Set *JWKSet `protobuf:"bytes,3,opt,name=set,proto3,oneof"`
}
...
func (*PublicKey_Set) isPublicKey_PublicKey() {}

// RSA private key prime information
type OtherPrimeInfo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// RSA private key parameter (Other Prime Factor)
	R string `protobuf:"bytes,1,opt,name=r,proto3" json:"r,omitempty"`
	// RSA private key parameter (Factor CRT Exponent)
	D string `protobuf:"bytes,2,opt,name=d,proto3" json:"d,omitempty"`
	// RSA private key parameter (Factor CRT Coefficient)
	T string `protobuf:"bytes,3,opt,name=t,proto3" json:"t,omitempty"`
}

func (x *OtherPrimeInfo) Reset() {
	*x = OtherPrimeInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *OtherPrimeInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OtherPrimeInfo) ProtoMessage() {}

func (x *OtherPrimeInfo) ProtoReflect() protoreflect.Message {
	mi := &file_policy_objects_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OtherPrimeInfo.ProtoReflect.Descriptor instead.
func (*OtherPrimeInfo) Descriptor() ([]byte, []int) {
	return file_policy_objects_proto_rawDescGZIP(), []int{13}
}

func (x *OtherPrimeInfo) GetR() string {
	if x != nil {
		return x.R
	}
	return ""
...
func (x *OtherPrimeInfo) GetD() string {
	if x != nil {
		return x.D
	}
	return ""
...
func (x *OtherPrimeInfo) GetT() string {
	if x != nil {
		return x.T
	}
	return ""
...
// Protocol buffer approximation of a JSON web key: https://datatracker.ietf.org/doc/html/rfc7517
type JWK struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Key type, as defined in JWA https://datatracker.ietf.org/doc/html/rfc7518
	Kty string `protobuf:"bytes,1,opt,name=kty,proto3" json:"kty,omitempty"`
	// Either `sig` or `enc`, if present.
	Use string `protobuf:"bytes,2,opt,name=use,proto3" json:"use,omitempty"`
	// Valid operations, e.g. `sign`, `verify`, `encrypt`, etc.
	KeyOps string `protobuf:"bytes,3,opt,name=key_ops,json=keyOps,proto3" json:"key_ops,omitempty"`
	Alg    string `protobuf:"bytes,4,opt,name=alg,proto3" json:"alg,omitempty"`
	// FIXME: Can this be an `any`?
	...
	X5Ts256 string `protobuf:"bytes,9,opt,name=x5ts256,json=x5t#s256,proto3" json:"x5ts256,omitempty"`
	// RSA parameters: https://datatracker.ietf.org/doc/html/rfc7518#section-6.3
	// Exponent of an RSA Public Key
	E string `protobuf:"bytes,10,opt,name=e,proto3" json:"e,omitempty"`
	// Modulus of an RSA Public Key
	N string `protobuf:"bytes,11,opt,name=n,proto3" json:"n,omitempty"`
	// RSA private key parameter (private exponent)
	// OR Elliptic Curve Private Key parameter (ECC Private Key)
	D string `protobuf:"bytes,12,opt,name=d,proto3" json:"d,omitempty"`
	// RSA private key parameter (First Prime Factor)
	P string `protobuf:"bytes,13,opt,name=p,proto3" json:"p,omitempty"`
	// RSA private key parameter (Second Prime Factor)
	Q string `protobuf:"bytes,14,opt,name=q,proto3" json:"q,omitempty"`
	// RSA private key parameter (First Factor CRT Exponent)
	Dp string `protobuf:"bytes,15,opt,name=dp,proto3" json:"dp,omitempty"`
	// RSA private key parameter (Second Factor CRT Exponent)
	Dq string `protobuf:"bytes,16,opt,name=dq,proto3" json:"dq,omitempty"`
	// RSA private key parameter (First CRT Coefficient)
	Qi string `protobuf:"bytes,17,opt,name=qi,proto3" json:"qi,omitempty"`
	// RSA private key parameter (Other Primes Info)
	Oth []*OtherPrimeInfo `protobuf:"bytes,18,rep,name=oth,proto3" json:"oth,omitempty"`
	// Elliptic Curve Key parameter (Curve)
	Crv string `protobuf:"bytes,21,opt,name=crv,proto3" json:"crv,omitempty"`
	// Elliptic Curve Key parameter (X Coordinate)
	X string `protobuf:"bytes,22,opt,name=x,proto3" json:"x,omitempty"`
	// Elliptic Curve Key parameter (Y Coordinate)
	Y string `protobuf:"bytes,23,opt,name=y,proto3" json:"y,omitempty"`
}
...
func (x *JWK) GetOth() []*OtherPrimeInfo {
	if x != nil {
		return x.Oth
	}
	return nil
...
var file_policy_objects_proto_rawDesc = []byte{
	...
	0x22, 0xa3, 0x01, 0x0a, 0x09, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x12, 0x0e,
	...
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0xec, 0x02, 0x0a, 0x09, 0x41, 0x74, 0x74, 0x72, 0x69,
	...
	0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0xf3, 0x02, 0x0a, 0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x2b, 0x0a, 0x07, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72,
	0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79,
	0x2e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x02, 0x18, 0x01, 0x52, 0x07, 0x6d, 0x65, 0x6d, 0x62,
	0x65, 0x72, 0x73, 0x12, 0x2f, 0x0a, 0x06, 0x67, 0x72, 0x61, 0x6e, 0x74, 0x73, 0x18, 0x05, 0x20,
	...
	0x75, 0x65, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x12, 0x41, 0x0a, 0x10, 0x73, 0x75,
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x5f, 0x6d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x73, 0x18, 0x08,
	...
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x73, 0x12, 0x2c, 0x0a,
	...
	0x61, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0xd6, 0x01, 0x0a, 0x06,
	0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x3b, 0x0a, 0x08, 0x73, 0x74, 0x61, 0x6e, 0x64, 0x61,
	...
	0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x06, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x22, 0x6c, 0x0a,
	...
	0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0xd7, 0x01, 0x0a, 0x09, 0x43, 0x6f, 0x6e,
	0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x45, 0x0a, 0x1f, 0x73, 0x75, 0x62, 0x6a, 0x65, 0x63,
	...
	,
	...
	0x64, 0x61, 0x74, 0x61, 0x52, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x80,
	0x01, 0x0a, 0x0f, 0x53, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72,
	0x74, 0x79, 0x12, 0x3e, 0x0a, 0x17, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x5f, 0x73,
	0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x42, 0x06, 0xba, 0x48, 0x03, 0xc8, 0x01, 0x01, 0x52, 0x15, 0x65, 0x78, 0x74,
	0x65, 0x72, 0x6e, 0x61, 0x6c, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x56, 0x61, 0x6c,
	0x75, 0x65, 0x12, 0x2d, 0x0a, 0x0e, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x5f, 0x76,
	...
	0x65, 0x22, 0xa5, 0x01, 0x0a, 0x0f, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x4d, 0x61,
	...
	0x28, 0x09, 0x52, 0x05, 0x74, 0x65, 0x72, 0x6d, 0x73, 0x22, 0x93, 0x01, 0x0a, 0x0f, 0x4b, 0x65,
	...
	0xdc, 0x03, 0x0a, 0x09, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x12, 0x84, 0x03,
	...
	,
	...
	0x5f, 0x4f, 0x52, 0x10, 0x02, 0x42, 0x82, 0x01, 0x0a, 0x0a, 0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x6f,
...
var file_policy_objects_proto_goTypes = []interface{}{
	...
	(*KeyAccessServer)(nil),         // 15: policy.KeyAccessServer
	(*PublicKey)(nil),               // 16: policy.PublicKey
	(*OtherPrimeInfo)(nil),          // 17: policy.OtherPrimeInfo
	(*JWK)(nil),                     // 18: policy.JWK
	(*JWKSet)(nil),                  // 19: policy.JWKSet
...
var file_policy_objects_proto_depIdxs = []int32{
	20, // 0: policy.Namespace.active:type_name -> google.protobuf.BoolValue
	21, // 1: policy.Namespace.metadata:type_name -> common.Metadata
	...
	15, // 5: policy.Attribute.grants:type_name -> policy.KeyAccessServer
	20, // 6: policy.Attribute.active:type_name -> google.protobuf.BoolValue
	21, // 7: policy.Attribute.metadata:type_name -> common.Metadata
	5,  // 8: policy.Value.attribute:type_name -> policy.Attribute
	6,  // 9: policy.Value.members:type_name -> policy.Value
	15, // 10: policy.Value.grants:type_name -> policy.KeyAccessServer
	20, // 11: policy.Value.active:type_name -> google.protobuf.BoolValue
	8,  // 12: policy.Value.subject_mappings:type_name -> policy.SubjectMapping
	21, // 13: policy.Value.metadata:type_name -> common.Metadata
	...
	21, // 18: policy.SubjectMapping.metadata:type_name -> common.Metadata
	...
	21, // 24: policy.SubjectConditionSet.metadata:type_name -> common.Metadata
	21, // 25: policy.ResourceMapping.metadata:type_name -> common.Metadata
	6,  // 26: policy.ResourceMapping.attribute_value:type_name -> policy.Value
	16, // 27: policy.KeyAccessServer.public_key:type_name -> policy.PublicKey
	21, // 28: policy.KeyAccessServer.metadata:type_name -> common.Metadata
	19, // 29: policy.PublicKey.set:type_name -> policy.JWKSet
	17, // 30: policy.JWK.oth:type_name -> policy.OtherPrimeInfo
	18, // 31: policy.JWKSet.keys:type_name -> policy.JWK
...
func file_policy_objects_proto_init() {
	...
	file_policy_objects_proto_msgTypes[12].OneofWrappers = []interface{}{
