...
var file_policy_objects_proto_rawDesc = []byte{
	...
	0x22, 0x9f, 0x04, 0x0a, 0x0f, 0x4b, 0x65, 0x79, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x53, 0x65,
	...
	0x61, 0x74, 0x61, 0x18, 0x64, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x63, 0x6f, 0x6d, 0x6d,
	0x6f, 0x6e, 0x2e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52, 0x08, 0x6d, 0x65, 0x74,
	0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0xa5, 0x01, 0x0a, 0x17, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74,
	...
	0x52, 0x10, 0x02, 0x2a, 0x88, 0x02, 0x0a, 0x13, 0x4b, 0x61, 0x73, 0x50, 0x75, 0x62, 0x6c, 0x69,
	...
	0x49, 0x43, 0x5f, 0x4b, 0x45, 0x59, 0x5f, 0x41, 0x4c, 0x47, 0x5f, 0x45, 0x4e, 0x55, 0x4d, 0x5f,
	0x45, 0x43, 0x5f, 0x53, 0x45, 0x43, 0x50, 0x35, 0x32, 0x31, 0x52, 0x31, 0x10, 0x07, 0x42, 0x82,
...
var file_policy_objects_proto_goTypes = []interface{}{
	...
	(*RegisteredResource)(nil),      // 22: policy.RegisteredResource
	(*RegisteredResourceValue)(nil), // 23: policy.RegisteredResourceValue
...
var file_policy_objects_proto_depIdxs = []int32{
	...
	25, // 18: policy.Action.metadata:type_name -> common.Metadata
	7,  // 19: policy.SubjectMapping.attribute_value:type_name -> policy.Value
	13, // 20: policy.SubjectMapping.subject_condition_set:type_name -> policy.SubjectConditionSet
	8,  // 21: policy.SubjectMapping.actions:type_name -> policy.Action
	25, // 22: policy.SubjectMapping.metadata:type_name -> common.Metadata
	1,  // 23: policy.Condition.operator:type_name -> policy.SubjectMappingOperatorEnum
	10, // 24: policy.ConditionGroup.conditions:type_name -> policy.Condition
	2,  // 25: policy.ConditionGroup.boolean_operator:type_name -> policy.ConditionBooleanTypeEnum
	11, // 26: policy.SubjectSet.condition_groups:type_name -> policy.ConditionGroup
	12, // 27: policy.SubjectConditionSet.subject_sets:type_name -> policy.SubjectSet
	25, // 28: policy.SubjectConditionSet.metadata:type_name -> common.Metadata
	25, // 29: policy.ResourceMappingGroup.metadata:type_name -> common.Metadata
	25, // 30: policy.ResourceMapping.metadata:type_name -> common.Metadata
	7,  // 31: policy.ResourceMapping.attribute_value:type_name -> policy.Value
	15, // 32: policy.ResourceMapping.group:type_name -> policy.ResourceMappingGroup
	21, // 33: policy.KeyAccessServer.public_key:type_name -> policy.PublicKey
	25, // 34: policy.KeyAccessServer.metadata:type_name -> common.Metadata
	24, // 35: policy.Key.is_active:type_name -> google.protobuf.BoolValue
	24, // 36: policy.Key.was_mapped:type_name -> google.protobuf.BoolValue
	19, // 37: policy.Key.public_key:type_name -> policy.KasPublicKey
	17, // 38: policy.Key.kas:type_name -> policy.KeyAccessServer
	25, // 39: policy.Key.metadata:type_name -> common.Metadata
	3,  // 40: policy.KasPublicKey.alg:type_name -> policy.KasPublicKeyAlgEnum
	19, // 41: policy.KasPublicKeySet.keys:type_name -> policy.KasPublicKey
	20, // 42: policy.PublicKey.cached:type_name -> policy.KasPublicKeySet
	23, // 43: policy.RegisteredResource.values:type_name -> policy.RegisteredResourceValue
	25, // 44: policy.RegisteredResource.metadata:type_name -> common.Metadata
	22, // 45: policy.RegisteredResourceValue.resource:type_name -> policy.RegisteredResource
	25, // 46: policy.RegisteredResourceValue.metadata:type_name -> common.Metadata
