...
var file_policy_objects_proto_depIdxs = []int32{
	...
	42, // 52: policy.RegisteredResource.metadata:type_name -> common.Metadata
	29, // 53: policy.RegisteredResourceValue.resource:type_name -> policy.RegisteredResource
	41, // 54: policy.RegisteredResourceValue.action_attribute_values:type_name -> policy.RegisteredResourceValue.ActionAttributeValue
	42, // 55: policy.RegisteredResourceValue.metadata:type_name -> common.Metadata
	31, // 56: policy.RequestContext.pep:type_name -> policy.PolicyEnforcementPoint
	12, // 57: policy.Obligation.namespace:type_name -> policy.Namespace
	34, // 58: policy.Obligation.values:type_name -> policy.ObligationValue
	42, // 59: policy.Obligation.metadata:type_name -> common.Metadata
	33, // 60: policy.ObligationValue.obligation:type_name -> policy.Obligation
	35, // 61: policy.ObligationValue.triggers:type_name -> policy.ObligationTrigger
	42, // 62: policy.ObligationValue.metadata:type_name -> common.Metadata
	34, // 63: policy.ObligationTrigger.obligation_value:type_name -> policy.ObligationValue
	15, // 64: policy.ObligationTrigger.action:type_name -> policy.Action
	14, // 65: policy.ObligationTrigger.attribute_value:type_name -> policy.Value
	32, // 66: policy.ObligationTrigger.context:type_name -> policy.RequestContext
	42, // 67: policy.ObligationTrigger.metadata:type_name -> common.Metadata
	39, // 68: policy.KasKey.key:type_name -> policy.AsymmetricKey
	...
	37, // 72: policy.AsymmetricKey.public_key_ctx:type_name -> policy.PublicKeyCtx
	38, // 73: policy.AsymmetricKey.private_key_ctx:type_name -> policy.PrivateKeyCtx
	11, // 74: policy.AsymmetricKey.provider_config:type_name -> policy.KeyProviderConfig
	42, // 75: policy.AsymmetricKey.metadata:type_name -> common.Metadata
	...
	42, // 79: policy.SymmetricKey.metadata:type_name -> common.Metadata
	15, // 80: policy.RegisteredResourceValue.ActionAttributeValue.action:type_name -> policy.Action
	14, // 81: policy.RegisteredResourceValue.ActionAttributeValue.attribute_value:type_name -> policy.Value
	42, // 82: policy.RegisteredResourceValue.ActionAttributeValue.metadata:type_name -> common.Metadata
