...
var file_policy_obligations_obligations_proto_depIdxs = []int32{
	...
	35, // 21: policy.obligations.AddObligationTriggerRequest.obligation_value:type_name -> common.IdFqnIdentifier
	36, // 22: policy.obligations.AddObligationTriggerRequest.action:type_name -> common.IdNameIdentifier
	35, // 23: policy.obligations.AddObligationTriggerRequest.attribute_value:type_name -> common.IdFqnIdentifier
	30, // 24: policy.obligations.AddObligationTriggerRequest.metadata:type_name -> common.MetadataMutable
	37, // 25: policy.obligations.AddObligationTriggerResponse.trigger:type_name -> policy.ObligationTrigger
	37, // 26: policy.obligations.RemoveObligationTriggerResponse.trigger:type_name -> policy.ObligationTrigger
	29, // 27: policy.obligations.GetObligationsByFQNsResponse.FqnObligationMapEntry.value:type_name -> policy.Obligation
	34, // 28: policy.obligations.GetObligationValuesByFQNsResponse.FqnValueMapEntry.value:type_name -> policy.ObligationValue
	11, // 29: policy.obligations.Service.ListObligations:input_type -> policy.obligations.ListObligationsRequest
	0,  // 30: policy.obligations.Service.GetObligation:input_type -> policy.obligations.GetObligationRequest
	3,  // 31: policy.obligations.Service.GetObligationsByFQNs:input_type -> policy.obligations.GetObligationsByFQNsRequest
	5,  // 32: policy.obligations.Service.CreateObligation:input_type -> policy.obligations.CreateObligationRequest
	7,  // 33: policy.obligations.Service.UpdateObligation:input_type -> policy.obligations.UpdateObligationRequest
	9,  // 34: policy.obligations.Service.DeleteObligation:input_type -> policy.obligations.DeleteObligationRequest
	13, // 35: policy.obligations.Service.GetObligationValue:input_type -> policy.obligations.GetObligationValueRequest
	15, // 36: policy.obligations.Service.GetObligationValuesByFQNs:input_type -> policy.obligations.GetObligationValuesByFQNsRequest
	17, // 37: policy.obligations.Service.CreateObligationValue:input_type -> policy.obligations.CreateObligationValueRequest
	19, // 38: policy.obligations.Service.UpdateObligationValue:input_type -> policy.obligations.UpdateObligationValueRequest
	21, // 39: policy.obligations.Service.DeleteObligationValue:input_type -> policy.obligations.DeleteObligationValueRequest
	23, // 40: policy.obligations.Service.AddObligationTrigger:input_type -> policy.obligations.AddObligationTriggerRequest
	25, // 41: policy.obligations.Service.RemoveObligationTrigger:input_type -> policy.obligations.RemoveObligationTriggerRequest
	12, // 42: policy.obligations.Service.ListObligations:output_type -> policy.obligations.ListObligationsResponse
	2,  // 43: policy.obligations.Service.GetObligation:output_type -> policy.obligations.GetObligationResponse
	4,  // 44: policy.obligations.Service.GetObligationsByFQNs:output_type -> policy.obligations.GetObligationsByFQNsResponse
	6,  // 45: policy.obligations.Service.CreateObligation:output_type -> policy.obligations.CreateObligationResponse
	8,  // 46: policy.obligations.Service.UpdateObligation:output_type -> policy.obligations.UpdateObligationResponse
	10, // 47: policy.obligations.Service.DeleteObligation:output_type -> policy.obligations.DeleteObligationResponse
	14, // 48: policy.obligations.Service.GetObligationValue:output_type -> policy.obligations.GetObligationValueResponse
	16, // 49: policy.obligations.Service.GetObligationValuesByFQNs:output_type -> policy.obligations.GetObligationValuesByFQNsResponse
	18, // 50: policy.obligations.Service.CreateObligationValue:output_type -> policy.obligations.CreateObligationValueResponse
	20, // 51: policy.obligations.Service.UpdateObligationValue:output_type -> policy.obligations.UpdateObligationValueResponse
	22, // 52: policy.obligations.Service.DeleteObligationValue:output_type -> policy.obligations.DeleteObligationValueResponse
	24, // 53: policy.obligations.Service.AddObligationTrigger:output_type -> policy.obligations.AddObligationTriggerResponse
	26, // 54: policy.obligations.Service.RemoveObligationTrigger:output_type -> policy.obligations.RemoveObligationTriggerResponse
