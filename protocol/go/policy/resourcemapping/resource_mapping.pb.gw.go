...
func request_ResourceMappingService_ListResourceMappingGroupsByAttrFQN_0(ctx context.Context, marshaler runtime.Marshaler, client ResourceMappingServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListResourceMappingGroupsByAttrFQNRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ListResourceMappingGroupsByAttrFQN(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ResourceMappingService_ListResourceMappingGroupsByAttrFQN_0(ctx context.Context, marshaler runtime.Marshaler, server ResourceMappingServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListResourceMappingGroupsByAttrFQNRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ListResourceMappingGroupsByAttrFQN(ctx, &protoReq)
	return msg, metadata, err
...
func request_ResourceMappingService_GetResourceMappingGroupByFQN_0(ctx context.Context, marshaler runtime.Marshaler, client ResourceMappingServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetResourceMappingGroupByFQNRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetResourceMappingGroupByFQN(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ResourceMappingService_GetResourceMappingGroupByFQN_0(ctx context.Context, marshaler runtime.Marshaler, server ResourceMappingServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetResourceMappingGroupByFQNRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetResourceMappingGroupByFQN(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterResourceMappingServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ResourceMappingServiceServer) error {
	...
	mux.Handle("GET", pattern_ResourceMappingService_ListResourceMappingGroupsByAttrFQN_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/policy.resourcemapping.ResourceMappingService/ListResourceMappingGroupsByAttrFQN", runtime.WithHTTPPathPattern("/resource-mapping-groups/attr-fqn/{fqn}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ResourceMappingService_ListResourceMappingGroupsByAttrFQN_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ResourceMappingService_ListResourceMappingGroupsByAttrFQN_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_ResourceMappingService_GetResourceMappingGroupByFQN_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/policy.resourcemapping.ResourceMappingService/GetResourceMappingGroupByFQN", runtime.WithHTTPPathPattern("/resource-mapping-groups/fqn/{fqn}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ResourceMappingService_GetResourceMappingGroupByFQN_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ResourceMappingService_GetResourceMappingGroupByFQN_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterResourceMappingServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ResourceMappingServiceClient) error {
	...
	mux.Handle("GET", pattern_ResourceMappingService_ListResourceMappingGroupsByAttrFQN_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/policy.resourcemapping.ResourceMappingService/ListResourceMappingGroupsByAttrFQN", runtime.WithHTTPPathPattern("/resource-mapping-groups/attr-fqn/{fqn}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ResourceMappingService_ListResourceMappingGroupsByAttrFQN_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_ResourceMappingService_GetResourceMappingGroupByFQN_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/policy.resourcemapping.ResourceMappingService/GetResourceMappingGroupByFQN", runtime.WithHTTPPathPattern("/resource-mapping-groups/fqn/{fqn}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ResourceMappingService_GetResourceMappingGroupByFQN_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ResourceMappingService_ListResourceMappingGroupsByAttrFQN_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"resource-mapping-groups", "attr-fqn", "fqn"}, ""))
	...
	pattern_ResourceMappingService_GetResourceMappingGroupByFQN_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 1}, []string{"resource-mapping-groups", "fqn"}, ""))
...
var (
	...
	forward_ResourceMappingService_ListResourceMappingGroupsByAttrFQN_0 = runtime.ForwardResponseMessage

	forward_ResourceMappingService_GetResourceMappingGroup_0 = runtime.ForwardResponseMessage

	forward_ResourceMappingService_GetResourceMappingGroupByFQN_0 = runtime.ForwardResponseMessage
