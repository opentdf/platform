...
func (x *DummyProto) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DummyProto) ProtoMessage() {}

func (x *DummyProto) ProtoReflect() protoreflect.Message {
	mi := &file_policy_selectors_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DummyProto.ProtoReflect.Descriptor instead.
func (*DummyProto) Descriptor() ([]byte, []int) {
	return file_policy_selectors_proto_rawDescGZIP(), []int{3}
}

func (x *DummyProto) GetHelloWorld() string {
	if x != nil {
		return x.HelloWorld
	}
	return ""
...
var file_policy_selectors_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x22, 0x2d, 0x0a, 0x0a, 0x44, 0x75,
	0x6d, 0x6d, 0x79, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1f, 0x0a, 0x0b, 0x68, 0x65, 0x6c, 0x6c,
	0x6f, 0x5f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x68,
	0x65, 0x6c, 0x6c, 0x6f, 0x57, 0x6f, 0x72, 0x6c, 0x64, 0x42, 0x94, 0x01, 0x0a, 0x1a, 0x69, 0x6f,
	0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x74, 0x64, 0x66, 0x2e, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72,
	0x6d, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x42, 0x0e, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74,
	0x6f, 0x72, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68,
...
var file_policy_selectors_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_policy_selectors_proto_goTypes = []interface{}{
	...
	(*DummyProto)(nil),                                                 // 3: policy.DummyProto
	(*AttributeNamespaceSelector_AttributeSelector)(nil),               // 4: policy.AttributeNamespaceSelector.AttributeSelector
	(*AttributeNamespaceSelector_AttributeSelector_ValueSelector)(nil), // 5: policy.AttributeNamespaceSelector.AttributeSelector.ValueSelector
	(*AttributeDefinitionSelector_NamespaceSelector)(nil),              // 6: policy.AttributeDefinitionSelector.NamespaceSelector
	(*AttributeDefinitionSelector_ValueSelector)(nil),                  // 7: policy.AttributeDefinitionSelector.ValueSelector
	(*AttributeValueSelector_AttributeSelector)(nil),                   // 8: policy.AttributeValueSelector.AttributeSelector
	(*AttributeValueSelector_AttributeSelector_NamespaceSelector)(nil), // 9: policy.AttributeValueSelector.AttributeSelector.NamespaceSelector
}
var file_policy_selectors_proto_depIdxs = []int32{
	4, // 0: policy.AttributeNamespaceSelector.with_attributes:type_name -> policy.AttributeNamespaceSelector.AttributeSelector
	6, // 1: policy.AttributeDefinitionSelector.with_namespace:type_name -> policy.AttributeDefinitionSelector.NamespaceSelector
	7, // 2: policy.AttributeDefinitionSelector.with_values:type_name -> policy.AttributeDefinitionSelector.ValueSelector
	8, // 3: policy.AttributeValueSelector.with_attribute:type_name -> policy.AttributeValueSelector.AttributeSelector
	5, // 4: policy.AttributeNamespaceSelector.AttributeSelector.with_values:type_name -> policy.AttributeNamespaceSelector.AttributeSelector.ValueSelector
	9, // 5: policy.AttributeValueSelector.AttributeSelector.with_namespace:type_name -> policy.AttributeValueSelector.AttributeSelector.NamespaceSelector
