...
/*
Package acse is a reverse proxy.
...
func RegisterSubjectEncodingServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SubjectEncodingServiceServer) error {
	...
	mux.Handle("GET", pattern_SubjectEncodingService_ListSubjectMappings_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/acse.SubjectEncodingService/ListSubjectMappings", runtime.WithHTTPPathPattern("/v1/encoding/subject/mappings"))
		if err != nil {
	...
	mux.Handle("GET", pattern_SubjectEncodingService_GetSubjectMapping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/acse.SubjectEncodingService/GetSubjectMapping", runtime.WithHTTPPathPattern("/v1/encoding/subject/mappings/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SubjectEncodingService_CreateSubjectMapping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/acse.SubjectEncodingService/CreateSubjectMapping", runtime.WithHTTPPathPattern("/v1/encoding/subject/mappings"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SubjectEncodingService_UpdateSubjectMapping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/acse.SubjectEncodingService/UpdateSubjectMapping", runtime.WithHTTPPathPattern("/v1/encoding/subject/mappings/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_SubjectEncodingService_DeleteSubjectMapping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/acse.SubjectEncodingService/DeleteSubjectMapping", runtime.WithHTTPPathPattern("/v1/encoding/subjects/mappings/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterSubjectEncodingServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SubjectEncodingServiceClient) error {
	...
	mux.Handle("GET", pattern_SubjectEncodingService_ListSubjectMappings_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/acse.SubjectEncodingService/ListSubjectMappings", runtime.WithHTTPPathPattern("/v1/encoding/subject/mappings"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_SubjectEncodingService_GetSubjectMapping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/acse.SubjectEncodingService/GetSubjectMapping", runtime.WithHTTPPathPattern("/v1/encoding/subject/mappings/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SubjectEncodingService_CreateSubjectMapping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/acse.SubjectEncodingService/CreateSubjectMapping", runtime.WithHTTPPathPattern("/v1/encoding/subject/mappings"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_SubjectEncodingService_UpdateSubjectMapping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/acse.SubjectEncodingService/UpdateSubjectMapping", runtime.WithHTTPPathPattern("/v1/encoding/subject/mappings/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_SubjectEncodingService_DeleteSubjectMapping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/acse.SubjectEncodingService/DeleteSubjectMapping", runtime.WithHTTPPathPattern("/v1/encoding/subjects/mappings/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
