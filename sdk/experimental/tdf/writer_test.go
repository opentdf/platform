...
func testBasicTDFCreationFlow(t *testing.T) {
	...
	segBytes, err := io.ReadAll(segResult.TDFData)
	require.NoError(t, err, "Failed to read segment TDF data")
	assert.NotEmpty(t, segBytes, "Zip bytes should not be empty")
