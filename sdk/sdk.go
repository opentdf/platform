...
func New(platformEndpoint string, opts ...Option) (*SDK, error) {
	...
	return &SDK{
		...
		Actions:                 sdkconnect.NewActionsConnectClient(platformConn.Client, platformConn.Endpoint, platformConn.Options...),
		Attributes:              sdkconnect.NewAttributesConnectClient(platformConn.Client, platformConn.Endpoint, platformConn.Options...),
		Namespaces:              sdkconnect.NewNamespacesConnectClient(platformConn.Client, platformConn.Endpoint, platformConn.Options...),
		RegisteredResources:     sdkconnect.NewRegisteredResourcesConnectClient(platformConn.Client, platformConn.Endpoint, platformConn.Options...),
		ResourceMapping:         sdkconnect.NewResourceMappingConnectClient(platformConn.Client, platformConn.Endpoint, platformConn.Options...),
		SubjectMapping:          sdkconnect.NewSubjectMappingConnectClient(platformConn.Client, platformConn.Endpoint, platformConn.Options...),
		Unsafe:                  sdkconnect.NewUnsafeConnectClient(platformConn.Client, platformConn.Endpoint, platformConn.Options...),
		KeyAccessServerRegistry: sdkconnect.NewKeyAccessServerRegistryConnectClient(platformConn.Client, platformConn.Endpoint, platformConn.Options...),
		Authorization:           sdkconnect.NewAuthorizationConnectClient(platformConn.Client, platformConn.Endpoint, platformConn.Options...),
		EntityResoution:         sdkconnect.NewEntityResolutionConnectClient(ersConn.Client, ersConn.Endpoint, ersConn.Options...),
		KeyManagement:           sdkconnect.NewKeyManagementConnectClient(platformConn.Client, platformConn.Endpoint, platformConn.Options...),
		wellknownConfiguration:  sdkconnect.NewWellKnownConfigurationConnectClient(platformConn.Client, platformConn.Endpoint, platformConn.Options...),
	}, nil
}
