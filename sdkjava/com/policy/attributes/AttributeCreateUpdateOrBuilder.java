...
public interface AttributeCreateUpdateOrBuilder extends
   ...
   * @return The rule.
   */
  com.policy.attributes.AttributeRuleTypeEnum getRule();
   ...
   */
  java.util.List<com.policy.attributes.ValueCreateUpdate> 
      getValuesList();
  /**
   * <pre>
   * optional
   ...
   * <code>repeated .policy.attributes.ValueCreateUpdate values = 5 [json_name = "values"];</code>
   */
  com.policy.attributes.ValueCreateUpdate getValues(int index);
  /**
   * <pre>
   * optional
   * </pre>
   ...
   * <code>repeated .policy.attributes.ValueCreateUpdate values = 5 [json_name = "values"];</code>
   */
  java.util.List<? extends com.policy.attributes.ValueCreateUpdateOrBuilder> 
   ...
   * <code>repeated .policy.attributes.ValueCreateUpdate values = 5 [json_name = "values"];</code>
   */
  com.policy.attributes.ValueCreateUpdateOrBuilder getValuesOrBuilder(
      int index);
}
