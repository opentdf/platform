...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.policy.resourcemapping.ResourceMappingProto.internal_static_policy_resourcemapping_ListResourceMappingsResponse_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.policy.resourcemapping.ResourceMappingProto.internal_static_policy_resourcemapping_ListResourceMappingsResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.policy.resourcemapping.ListResourceMappingsResponse.class, com.policy.resourcemapping.ListResourceMappingsResponse.Builder.class);
  }

  public static final int RESOURCE_MAPPINGS_FIELD_NUMBER = 1;
  @SuppressWarnings("serial")
  private java.util.List<com.policy.resourcemapping.ResourceMapping> resourceMappings_;
  /**
   * <code>repeated .policy.resourcemapping.ResourceMapping resource_mappings = 1 [json_name = "resourceMappings"];</code>
   */
  @java.lang.Override
  public java.util.List<com.policy.resourcemapping.ResourceMapping> getResourceMappingsList() {
   ...
   */
  @java.lang.Override
  public java.util.List<? extends com.policy.resourcemapping.ResourceMappingOrBuilder> 
   ...
   */
  @java.lang.Override
  public com.policy.resourcemapping.ResourceMapping getResourceMappings(int index) {
   ...
   */
  @java.lang.Override
  public com.policy.resourcemapping.ResourceMappingOrBuilder getResourceMappingsOrBuilder(
      int index) {
    return resourceMappings_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.policy.resourcemapping.ListResourceMappingsResponse)) {
      return super.equals(obj);
    }
    com.policy.resourcemapping.ListResourceMappingsResponse other = (com.policy.resourcemapping.ListResourceMappingsResponse) obj;
  ...
  public static com.policy.resourcemapping.ListResourceMappingsResponse parseFrom(
  ...
  public static com.policy.resourcemapping.ListResourceMappingsResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.policy.resourcemapping.ListResourceMappingsResponse parseFrom(
  ...
  public static com.policy.resourcemapping.ListResourceMappingsResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.policy.resourcemapping.ListResourceMappingsResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static com.policy.resourcemapping.ListResourceMappingsResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.policy.resourcemapping.ListResourceMappingsResponse prototype) {
  ...
  public static final class Builder extends
      ...
      com.policy.resourcemapping.ListResourceMappingsResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return com.policy.resourcemapping.ResourceMappingProto.internal_static_policy_resourcemapping_ListResourceMappingsResponse_descriptor;
    }
    ...
    // Construct using com.policy.resourcemapping.ListResourceMappingsResponse.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.policy.resourcemapping.ListResourceMappingsResponse getDefaultInstanceForType() {
      return com.policy.resourcemapping.ListResourceMappingsResponse.getDefaultInstance();
    }

    @java.lang.Override
    public com.policy.resourcemapping.ListResourceMappingsResponse build() {
      com.policy.resourcemapping.ListResourceMappingsResponse result = buildPartial();
    ...
    @java.lang.Override
    public com.policy.resourcemapping.ListResourceMappingsResponse buildPartial() {
      com.policy.resourcemapping.ListResourceMappingsResponse result = new com.policy.resourcemapping.ListResourceMappingsResponse(this);
    ...
    private void buildPartialRepeatedFields(com.policy.resourcemapping.ListResourceMappingsResponse result) {
      if (resourceMappingsBuilder_ == null) {
    ...
    private void buildPartial0(com.policy.resourcemapping.ListResourceMappingsResponse result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.policy.resourcemapping.ListResourceMappingsResponse) {
        return mergeFrom((com.policy.resourcemapping.ListResourceMappingsResponse)other);
      } else {
    ...
    public Builder mergeFrom(com.policy.resourcemapping.ListResourceMappingsResponse other) {
      if (other == com.policy.resourcemapping.ListResourceMappingsResponse.getDefaultInstance()) return this;
      if (resourceMappingsBuilder_ == null) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              com.policy.resourcemapping.ResourceMapping m =
                  input.readMessage(
                      com.policy.resourcemapping.ResourceMapping.parser(),
                      extensionRegistry);
              if (resourceMappingsBuilder_ == null) {
                ensureResourceMappingsIsMutable();
    ...
    private void ensureResourceMappingsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        resourceMappings_ = new java.util.ArrayList<com.policy.resourcemapping.ResourceMapping>(resourceMappings_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.policy.resourcemapping.ResourceMapping, com.policy.resourcemapping.ResourceMapping.Builder, com.policy.resourcemapping.ResourceMappingOrBuilder> resourceMappingsBuilder_;
    ...
    public Builder setResourceMappings(
        int index, com.policy.resourcemapping.ResourceMapping value) {
      if (resourceMappingsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setResourceMappings(
        int index, com.policy.resourcemapping.ResourceMapping.Builder builderForValue) {
      if (resourceMappingsBuilder_ == null) {
        ensureResourceMappingsIsMutable();
     ...
     * <code>repeated .policy.resourcemapping.ResourceMapping resource_mappings = 1 [json_name = "resourceMappings"];</code>
     */
    public Builder addResourceMappings(com.policy.resourcemapping.ResourceMapping value) {
      if (resourceMappingsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllResourceMappings(
        java.lang.Iterable<? extends com.policy.resourcemapping.ResourceMapping> values) {
      if (resourceMappingsBuilder_ == null) {
        ensureResourceMappingsIsMutable();
     ...
     * <code>repeated .policy.resourcemapping.ResourceMapping resource_mappings = 1 [json_name = "resourceMappings"];</code>
     */
    public com.policy.resourcemapping.ResourceMapping.Builder getResourceMappingsBuilder(
        int index) {
     ...
     * <code>repeated .policy.resourcemapping.ResourceMapping resource_mappings = 1 [json_name = "resourceMappings"];</code>
     */
    public com.policy.resourcemapping.ResourceMapping.Builder addResourceMappingsBuilder() {
      return getResourceMappingsFieldBuilder().addBuilder(
          com.policy.resourcemapping.ResourceMapping.getDefaultInstance());
    }
    /**
     * <code>repeated .policy.resourcemapping.ResourceMapping resource_mappings = 1 [json_name = "resourceMappings"];</code>
     */
    public com.policy.resourcemapping.ResourceMapping.Builder addResourceMappingsBuilder(
        int index) {
      return getResourceMappingsFieldBuilder().addBuilder(
          index, com.policy.resourcemapping.ResourceMapping.getDefaultInstance());
    }
    /**
     * <code>repeated .policy.resourcemapping.ResourceMapping resource_mappings = 1 [json_name = "resourceMappings"];</code>
     */
    public java.util.List<com.policy.resourcemapping.ResourceMapping.Builder> 
  ...
  private static final com.policy.resourcemapping.ListResourceMappingsResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.policy.resourcemapping.ListResourceMappingsResponse();
  }

  public static com.policy.resourcemapping.ListResourceMappingsResponse getDefaultInstance() {
