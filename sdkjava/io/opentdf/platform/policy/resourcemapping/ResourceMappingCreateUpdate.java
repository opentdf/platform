...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.opentdf.platform.policy.resourcemapping.ResourceMappingProto.internal_static_policy_resourcemapping_ResourceMappingCreateUpdate_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.opentdf.platform.policy.resourcemapping.ResourceMappingProto.internal_static_policy_resourcemapping_ResourceMappingCreateUpdate_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate.class, io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate)) {
      return super.equals(obj);
    }
    io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate other = (io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate) obj;
  ...
  public static io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate parseFrom(
  ...
  public static io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate parseFrom(
  ...
  public static io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate getDefaultInstanceForType() {
      return io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate.getDefaultInstance();
    }

    @java.lang.Override
    public io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate build() {
      io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate result = buildPartial();
    ...
    @java.lang.Override
    public io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate buildPartial() {
      io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate result = new io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate) {
        return mergeFrom((io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate)other);
      } else {
    ...
    public Builder mergeFrom(io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate other) {
      if (other == io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate.getDefaultInstance()) return this;
  ...
  private static final io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate();
  }

  public static io.opentdf.platform.policy.resourcemapping.ResourceMappingCreateUpdate getDefaultInstance() {
