...
/**
 * Protobuf type {@code opentdf.platform.subjectmapping.ListSubjectMappingsResponse}
 */
public final class ListSubjectMappingsResponse extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:opentdf.platform.subjectmapping.ListSubjectMappingsResponse)
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.opentdf.platform.subjectmapping.SubjectMappingProto.internal_static_opentdf_platform_subjectmapping_ListSubjectMappingsResponse_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.opentdf.platform.subjectmapping.SubjectMappingProto.internal_static_opentdf_platform_subjectmapping_ListSubjectMappingsResponse_fieldAccessorTable
  ...
  private java.util.List<io.opentdf.platform.subjectmapping.SubjectMapping> subjectMappings_;
  /**
   * <code>repeated .opentdf.platform.subjectmapping.SubjectMapping subject_mappings = 1 [json_name = "subjectMappings"];</code>
   */
  @java.lang.Override
  public java.util.List<io.opentdf.platform.subjectmapping.SubjectMapping> getSubjectMappingsList() {
   ...
   */
  @java.lang.Override
  public java.util.List<? extends io.opentdf.platform.subjectmapping.SubjectMappingOrBuilder> 
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:opentdf.platform.subjectmapping.ListSubjectMappingsResponse)
    ...
    private void ensureSubjectMappingsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        subjectMappings_ = new java.util.ArrayList<io.opentdf.platform.subjectmapping.SubjectMapping>(subjectMappings_);
    ...
    public Builder addAllSubjectMappings(
        java.lang.Iterable<? extends io.opentdf.platform.subjectmapping.SubjectMapping> values) {
      if (subjectMappingsBuilder_ == null) {
        ensureSubjectMappingsIsMutable();
     ...
     * <code>repeated .opentdf.platform.subjectmapping.SubjectMapping subject_mappings = 1 [json_name = "subjectMappings"];</code>
     */
    public java.util.List<io.opentdf.platform.subjectmapping.SubjectMapping.Builder> 
    ...
    // @@protoc_insertion_point(builder_scope:opentdf.platform.subjectmapping.ListSubjectMappingsResponse)
  }

  // @@protoc_insertion_point(class_scope:opentdf.platform.subjectmapping.ListSubjectMappingsResponse)
