...
public interface SubjectMappingOrBuilder extends
    // @@protoc_insertion_point(interface_extends:opentdf.platform.subjectmapping.SubjectMapping)
   ...
   */
  io.opentdf.platform.attributes.Value getAttributeValue();
  /**
   * <pre>
   * Attribute Value to be mapped to
   * </pre>
   ...
   * <code>.opentdf.platform.attributes.Value attribute_value = 3 [json_name = "attributeValue"];</code>
   */
  io.opentdf.platform.attributes.ValueOrBuilder getAttributeValueOrBuilder();
