...
public interface InfoOrBuilder extends
   ...
   * @return The contact.
   */
  grpc.gateway.protoc_gen_openapiv2.options.Contact getContact();
  /**
   * <pre>
   * The contact information for the exposed API.
   * </pre>
   ...
   * <code>.grpc.gateway.protoc_gen_openapiv2.options.Contact contact = 4 [json_name = "contact"];</code>
   */
  grpc.gateway.protoc_gen_openapiv2.options.ContactOrBuilder getContactOrBuilder();
   ...
   * @return The license.
   */
  grpc.gateway.protoc_gen_openapiv2.options.License getLicense();
  /**
   * <pre>
   * The license information for the exposed API.
   * </pre>
   ...
   * <code>.grpc.gateway.protoc_gen_openapiv2.options.License license = 5 [json_name = "license"];</code>
   */
  grpc.gateway.protoc_gen_openapiv2.options.LicenseOrBuilder getLicenseOrBuilder();
