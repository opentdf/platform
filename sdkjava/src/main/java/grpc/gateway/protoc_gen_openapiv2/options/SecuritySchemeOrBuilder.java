...
public interface SecuritySchemeOrBuilder extends
   ...
   * @return The type.
   */
  grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme.Type getType();
   ...
   * @return The in.
   */
  grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme.In getIn();
   ...
   * @return The flow.
   */
  grpc.gateway.protoc_gen_openapiv2.options.SecurityScheme.Flow getFlow();
   ...
   * @return The scopes.
   */
  grpc.gateway.protoc_gen_openapiv2.options.Scopes getScopes();
  /**
   * <pre>
   * The available scopes for the OAuth2 security scheme.
   * Valid for oauth2.
   ...
   * <code>.grpc.gateway.protoc_gen_openapiv2.options.Scopes scopes = 8 [json_name = "scopes"];</code>
   */
  grpc.gateway.protoc_gen_openapiv2.options.ScopesOrBuilder getScopesOrBuilder();
