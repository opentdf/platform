...
public final class AuthorizationServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.opentdf.platform.authorization.GetDecisionsRequest,
      io.opentdf.platform.authorization.GetDecisionsResponse> getGetDecisionsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetDecisions",
      requestType = io.opentdf.platform.authorization.GetDecisionsRequest.class,
      responseType = io.opentdf.platform.authorization.GetDecisionsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.opentdf.platform.authorization.GetDecisionsRequest,
      io.opentdf.platform.authorization.GetDecisionsResponse> getGetDecisionsMethod() {
    io.grpc.MethodDescriptor<io.opentdf.platform.authorization.GetDecisionsRequest, io.opentdf.platform.authorization.GetDecisionsResponse> getGetDecisionsMethod;
      ...
      synchronized (AuthorizationServiceGrpc.class) {
        if ((getGetDecisionsMethod = AuthorizationServiceGrpc.getGetDecisionsMethod) == null) {
          AuthorizationServiceGrpc.getGetDecisionsMethod = getGetDecisionsMethod =
              io.grpc.MethodDescriptor.<io.opentdf.platform.authorization.GetDecisionsRequest, io.opentdf.platform.authorization.GetDecisionsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetDecisions"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.opentdf.platform.authorization.GetDecisionsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.opentdf.platform.authorization.GetDecisionsResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<io.opentdf.platform.authorization.GetEntitlementsRequest,
      io.opentdf.platform.authorization.GetEntitlementsResponse> getGetEntitlementsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetEntitlements",
      requestType = io.opentdf.platform.authorization.GetEntitlementsRequest.class,
      responseType = io.opentdf.platform.authorization.GetEntitlementsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.opentdf.platform.authorization.GetEntitlementsRequest,
      io.opentdf.platform.authorization.GetEntitlementsResponse> getGetEntitlementsMethod() {
    io.grpc.MethodDescriptor<io.opentdf.platform.authorization.GetEntitlementsRequest, io.opentdf.platform.authorization.GetEntitlementsResponse> getGetEntitlementsMethod;
      ...
      synchronized (AuthorizationServiceGrpc.class) {
        if ((getGetEntitlementsMethod = AuthorizationServiceGrpc.getGetEntitlementsMethod) == null) {
          AuthorizationServiceGrpc.getGetEntitlementsMethod = getGetEntitlementsMethod =
              io.grpc.MethodDescriptor.<io.opentdf.platform.authorization.GetEntitlementsRequest, io.opentdf.platform.authorization.GetEntitlementsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetEntitlements"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.opentdf.platform.authorization.GetEntitlementsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.opentdf.platform.authorization.GetEntitlementsResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getDecisions(io.opentdf.platform.authorization.GetDecisionsRequest request,
        io.grpc.stub.StreamObserver<io.opentdf.platform.authorization.GetDecisionsResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetDecisionsMethod(), responseObserver);
    }

    /**
     */
    default void getEntitlements(io.opentdf.platform.authorization.GetEntitlementsRequest request,
        io.grpc.stub.StreamObserver<io.opentdf.platform.authorization.GetEntitlementsResponse> responseObserver) {
  ...
  public static final class AuthorizationServiceStub
    ...
    /**
     */
    public void getDecisions(io.opentdf.platform.authorization.GetDecisionsRequest request,
        io.grpc.stub.StreamObserver<io.opentdf.platform.authorization.GetDecisionsResponse> responseObserver) {
    ...
    /**
     */
    public void getEntitlements(io.opentdf.platform.authorization.GetEntitlementsRequest request,
        io.grpc.stub.StreamObserver<io.opentdf.platform.authorization.GetEntitlementsResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class AuthorizationServiceBlockingStub
    ...
    /**
     */
    public io.opentdf.platform.authorization.GetDecisionsResponse getDecisions(io.opentdf.platform.authorization.GetDecisionsRequest request) {
    ...
    /**
     */
    public io.opentdf.platform.authorization.GetEntitlementsResponse getEntitlements(io.opentdf.platform.authorization.GetEntitlementsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AuthorizationServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.opentdf.platform.authorization.GetDecisionsResponse> getDecisions(
        io.opentdf.platform.authorization.GetDecisionsRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.opentdf.platform.authorization.GetEntitlementsResponse> getEntitlements(
        io.opentdf.platform.authorization.GetEntitlementsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DECISIONS:
          serviceImpl.getDecisions((io.opentdf.platform.authorization.GetDecisionsRequest) request,
              (io.grpc.stub.StreamObserver<io.opentdf.platform.authorization.GetDecisionsResponse>) responseObserver);
          break;
        case METHODID_GET_ENTITLEMENTS:
          serviceImpl.getEntitlements((io.opentdf.platform.authorization.GetEntitlementsRequest) request,
              (io.grpc.stub.StreamObserver<io.opentdf.platform.authorization.GetEntitlementsResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              io.opentdf.platform.authorization.GetDecisionsRequest,
              io.opentdf.platform.authorization.GetDecisionsResponse>(
                service, METHODID_GET_DECISIONS)))
        .addMethod(
          getGetEntitlementsMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              io.opentdf.platform.authorization.GetEntitlementsRequest,
              io.opentdf.platform.authorization.GetEntitlementsResponse>(
  ...
  private static abstract class AuthorizationServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.opentdf.platform.authorization.AuthorizationProto.getDescriptor();
    }
