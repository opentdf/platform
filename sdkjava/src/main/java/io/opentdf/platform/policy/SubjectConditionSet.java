...
private static final long serialVersionUID = 0L;
  ...
  private SubjectConditionSet(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
  private SubjectConditionSet() {
    id_ = "";
  ...
  protected java.lang.Object newInstance(
    ...
    return new SubjectConditionSet();
  }

  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.opentdf.platform.policy.TypesProto.internal_static_policy_SubjectConditionSet_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.opentdf.platform.policy.TypesProto.internal_static_policy_SubjectConditionSet_fieldAccessorTable
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:policy.SubjectConditionSet)
      io.opentdf.platform.policy.SubjectConditionSetOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.opentdf.platform.policy.TypesProto.internal_static_policy_SubjectConditionSet_descriptor;
    }
    ...
    // Construct using io.opentdf.platform.policy.SubjectConditionSet.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.opentdf.platform.policy.SubjectConditionSet getDefaultInstanceForType() {
      return io.opentdf.platform.policy.SubjectConditionSet.getDefaultInstance();
    }

    @java.lang.Override
    public io.opentdf.platform.policy.SubjectConditionSet build() {
      io.opentdf.platform.policy.SubjectConditionSet result = buildPartial();
    ...
    @java.lang.Override
    public io.opentdf.platform.policy.SubjectConditionSet buildPartial() {
      io.opentdf.platform.policy.SubjectConditionSet result = new io.opentdf.platform.policy.SubjectConditionSet(this);
    ...
    private void buildPartialRepeatedFields(io.opentdf.platform.policy.SubjectConditionSet result) {
      if (subjectSetsBuilder_ == null) {
    ...
    private void buildPartial0(io.opentdf.platform.policy.SubjectConditionSet result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.opentdf.platform.policy.SubjectConditionSet) {
        return mergeFrom((io.opentdf.platform.policy.SubjectConditionSet)other);
      } else {
    ...
    public Builder mergeFrom(io.opentdf.platform.policy.SubjectConditionSet other) {
      if (other == io.opentdf.platform.policy.SubjectConditionSet.getDefaultInstance()) return this;
    ...
    // @@protoc_insertion_point(builder_scope:policy.SubjectConditionSet)
  }

  // @@protoc_insertion_point(class_scope:policy.SubjectConditionSet)
  private static final io.opentdf.platform.policy.SubjectConditionSet DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.opentdf.platform.policy.SubjectConditionSet();
  }

  public static io.opentdf.platform.policy.SubjectConditionSet getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final com.google.protobuf.Parser<SubjectConditionSet>
      PARSER = new com.google.protobuf.AbstractParser<SubjectConditionSet>() {
    @java.lang.Override
    public SubjectConditionSet parsePartialFrom(
        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
  ...
  public static com.google.protobuf.Parser<SubjectConditionSet> parser() {
    return PARSER;
  }

  @java.lang.Override
  public com.google.protobuf.Parser<SubjectConditionSet> getParserForType() {
    return PARSER;
  }
