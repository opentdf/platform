...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.opentdf.platform.policy.attributes.AttributesProto.internal_static_policy_attributes_AssignKeyAccessServerToAttributeResponse_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.opentdf.platform.policy.attributes.AttributesProto.internal_static_policy_attributes_AssignKeyAccessServerToAttributeResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse.class, io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse)) {
      return super.equals(obj);
    }
    io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse other = (io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse) obj;
  ...
  public static io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse parseFrom(
  ...
  public static io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse parseFrom(
  ...
  public static io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse prototype) {
  ...
  public static final class Builder extends
      ...
      io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.opentdf.platform.policy.attributes.AttributesProto.internal_static_policy_attributes_AssignKeyAccessServerToAttributeResponse_descriptor;
    }
    ...
    // Construct using io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse getDefaultInstanceForType() {
      return io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse.getDefaultInstance();
    }

    @java.lang.Override
    public io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse build() {
      io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse result = buildPartial();
    ...
    @java.lang.Override
    public io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse buildPartial() {
      io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse result = new io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse) {
        return mergeFrom((io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse)other);
      } else {
    ...
    public Builder mergeFrom(io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse other) {
      if (other == io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse.getDefaultInstance()) return this;
  ...
  private static final io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse();
  }

  public static io.opentdf.platform.policy.attributes.AssignKeyAccessServerToAttributeResponse getDefaultInstance() {
