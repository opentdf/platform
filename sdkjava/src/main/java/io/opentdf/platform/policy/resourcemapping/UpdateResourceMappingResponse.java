...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.opentdf.platform.policy.resourcemapping.ResourceMappingProto.internal_static_policy_resourcemapping_UpdateResourceMappingResponse_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.opentdf.platform.policy.resourcemapping.ResourceMappingProto.internal_static_policy_resourcemapping_UpdateResourceMappingResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse.class, io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse)) {
      return super.equals(obj);
    }
    io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse other = (io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse) obj;
  ...
  public static io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse parseFrom(
  ...
  public static io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse parseFrom(
  ...
  public static io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse getDefaultInstanceForType() {
      return io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse.getDefaultInstance();
    }

    @java.lang.Override
    public io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse build() {
      io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse result = buildPartial();
    ...
    @java.lang.Override
    public io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse buildPartial() {
      io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse result = new io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse) {
        return mergeFrom((io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse)other);
      } else {
    ...
    public Builder mergeFrom(io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse other) {
      if (other == io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse.getDefaultInstance()) return this;
  ...
  private static final io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse();
  }

  public static io.opentdf.platform.policy.resourcemapping.UpdateResourceMappingResponse getDefaultInstance() {
