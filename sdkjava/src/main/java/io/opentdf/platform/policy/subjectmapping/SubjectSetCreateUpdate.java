...
/**
 * Protobuf type {@code policy.subjectmapping.SubjectSetCreateUpdate}
 */
public final class SubjectSetCreateUpdate extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:policy.subjectmapping.SubjectSetCreateUpdate)
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return io.opentdf.platform.policy.subjectmapping.SubjectMappingProto.internal_static_policy_subjectmapping_SubjectSetCreateUpdate_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return io.opentdf.platform.policy.subjectmapping.SubjectMappingProto.internal_static_policy_subjectmapping_SubjectSetCreateUpdate_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate.class, io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate)) {
      return super.equals(obj);
    }
    io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate other = (io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate) obj;
  ...
  public static io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate parseFrom(
  ...
  public static io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate parseFrom(
  ...
  public static io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:policy.subjectmapping.SubjectSetCreateUpdate)
      io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdateOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return io.opentdf.platform.policy.subjectmapping.SubjectMappingProto.internal_static_policy_subjectmapping_SubjectSetCreateUpdate_descriptor;
    }
    ...
    // Construct using io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate build() {
      io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate result = buildPartial();
    ...
    @java.lang.Override
    public io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate buildPartial() {
      io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate result = new io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate(this);
    ...
    private void buildPartialRepeatedFields(io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate result) {
      if (conditionGroupsBuilder_ == null) {
    ...
    private void buildPartial0(io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate) {
        return mergeFrom((io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate)other);
      } else {
    ...
    public Builder mergeFrom(io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate other) {
      if (other == io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate.getDefaultInstance()) return this;
    ...
    // @@protoc_insertion_point(builder_scope:policy.subjectmapping.SubjectSetCreateUpdate)
  }

  // @@protoc_insertion_point(class_scope:policy.subjectmapping.SubjectSetCreateUpdate)
  private static final io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new io.opentdf.platform.policy.subjectmapping.SubjectSetCreateUpdate();
  }
