...
type PolicyConfig struct {
	...
	// Adapter specifies the Casbin adapter to use for policy storage.
	Adapter string `mapstructure:"adapter" json:"adapter" default:"csv"`
	// RuntimeAdapter is a non-config field used to inject a constructed adapter instance
	// (e.g., SQL-backed via GORM). It is ignored by mapstructure/json.
	RuntimeAdapter persist.Adapter `mapstructure:"-" json:"-"`
}
