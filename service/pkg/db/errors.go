...
var (
	...
	ErrDeprecated                 = errors.New("ErrDeprecated: field or operation is deprecated")
...
const (
	...
	ErrorTextDeprecated                 = "field or operation is deprecated"
...
func StatusifyError(ctx context.Context, l *logger.Logger, err error, fallbackErr string, logs ...any) error {
	...
	if errors.Is(err, ErrDeprecated) {
		l.ErrorContext(ctx, ErrorTextDeprecated, logs...)
		return connect.NewError(connect.CodeInvalidArgument, errors.New(ErrorTextDeprecated))
	}
