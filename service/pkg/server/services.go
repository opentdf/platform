...
func startServices(ctx context.Context, cfg config.Config, otdf *server.OpenTDFServer, client *sdk.SDK, cryptoService *cryptoproviders.CryptoService, logger *logging.Logger, reg serviceregistry.Registry) error {
