...
entity_representations := keycloak.resolve.entities(idp_request, idp_config).entityRepresentations

attributes := subjectmapping.resolve(input.attribute_mappings, entity_representations)
