...
// Table to store non data resource groups
type NonDataResourceGroup struct {
	// Primary key for the table
	ID string `json:"id"`
	// Name for the non data resource group
	Name string `json:"name"`
	// Metadata for the non data resource group (see protos for structure)
	Metadata []byte `json:"metadata"`
...
// Table to store non data resource values
type NonDataResourceValue struct {
	// Primary key for the table
	ID string `json:"id"`
	// Foreign key to the non data resource groups table
	NonDataResourceGroupID string `json:"non_data_resource_group_id"`
	// Value for the non data resource
	Value string `json:"value"`
	// Metadata for the non data resource value (see protos for structure)
	Metadata []byte `json:"metadata"`
	// Timestamp when the record was created
	CreatedAt pgtype.Timestamptz `json:"created_at"`
	// Timestamp when the record was last updated
