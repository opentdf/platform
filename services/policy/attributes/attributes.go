...
func (s *AttributesService) DeleteAttribute(ctx context.Context,
	req *attr.DeleteAttributeRequest,
) (*attr.DeleteAttributeResponse, error) {
	rsp := &attr.DeleteAttributeResponse{}
...
func (s *AttributesService) DeleteAttributeValue(ctx context.Context, req *attr.DeleteAttributeValueRequest) (*attr.DeleteAttributeValueResponse, error) {
	a, err := s.dbClient.DeleteAttributeValue(ctx, req.Id)
	if err != nil {
		return nil, services.HandleError(err, services.ErrDeletionFailed, slog.String("id", req.Id))
	}

	return &attr.DeleteAttributeValueResponse{
		Value: a,
	}, nil
}
