...
- DEBUG: If set to DEBUG a local in process platform is launched for purposes of debugging a scenario.  This should not be used for testing more than one scenario as the inline DSP version does not support multiple platform installs.
