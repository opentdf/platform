...
Feature: v2 multi-resource decisions at large policy scale
  ...
  Scenario Outline: Concurrent multi-resource decisions complete within five seconds with 6011 subject mappings at concurrency <concurrency>
    ...
    When I send <concurrency> concurrent multi-resource decision requests for entity chain "scale-user" for "read" action on resources each within "5s":
      | resource                                                        |
